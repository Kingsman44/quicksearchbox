...
/* renamed from: com.google.research.a.e.t */
/* compiled from: PG */
public class C66370t extends C66374x {

    /* renamed from: a */
    protected final int f180461a;

    /* renamed from: b */
    protected final C66326q f180462b = new C66326q();

    /* renamed from: c */
    protected final C66316g f180463c;

    /* renamed from: d */
    protected C66372v f180464d;

    /* renamed from: e */
    private final Set f180465e;

    public C66370t() {
        HashSet hashSet = new HashSet();
        this.f180465e = hashSet;
        hashSet.add("appShare");
        ...
        this.f180463c = fVar;
        C66315f fVar2 = fVar;
        int i = fVar.f180327a + 9;
        this.f180461a = i;
        this.f180464d = new C66358h(i);
    }
    ...
    public final int mo59576a(C66376a aVar) {
        ...
        String a = aVar.mo59466i().mo59478a();
        for (int i = 0; i < c.size(); i++) {
            if (C58832aw.m90831a(aVar.mo59460c(), C66291n.m96856b((C66307h) c.get(i), a))) {
                return i;
            }
        }
        return -1;
    ...
    public final C66343o mo59577b(C66376a aVar) {
        return C66291n.m96857c(this.f180462b.mo59530b(this.f180447l.f180433a, aVar), this.f180463c.mo59527p(this.f180447l.f180433a, aVar));
    }

    /* renamed from: d */
    public C66372v mo59578d() {
        return this.f180464d;
    }

    /* renamed from: e */
    public String mo59575e() {
        return "sharesheet_shareapp_logistic_predictor";
    }
    ...
    public final ArrayList mo59579f(C66376a aVar, float[] fArr) {
        ...
        String a = aVar.mo59466i().mo59478a();
        for (int i = 0; i < c.size(); i++) {
            arrayList.add(new C66366p(C66291n.m96856b((C66307h) c.get(i), a), fArr[i], this.f180465e));
        }
        return arrayList;
    }
    ...
    public void mo59580g(DataInputStream dataInputStream, C66376a aVar) {
        ...
        if (!readUTF.equals("sharesheet_shareapp_logistic_predictor")) {
            throw new IOException("Inconsistent ending: [" + readUTF + "] expected: [sharesheet_shareapp_logistic_predictor]");
        }
    }
    ...
    public void mo59581h(DataOutputStream dataOutputStream) {
        ...
        dataOutputStream.writeUTF("sharesheet_shareapp_logistic_predictor");
    }

    /* renamed from: i */
    public final boolean mo59582i(C66376a aVar) {
        return aVar.mo59463f() == 10 && aVar.mo59466i().mo59478a().equals("share_app");
    }
}
