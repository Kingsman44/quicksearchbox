...
/* renamed from: com.google.bv.e.b.c.a.f */
/* compiled from: PG */
public enum C57323f implements C62957cd {
    UNKNOWN_SURFACE(0),
    AGSA_MAIN_SCREEN(1),
    ...
    /* renamed from: C */
    private final int f153049C;

    private C57323f(int i) {
        this.f153049C = i;
    }

    /* renamed from: a */
    public static C57323f m88314a(int i) {
        switch (i) {
            case 0:
    ...
    /* renamed from: b */
    public static C62959cf m88315b() {
        return C57322e.f153019a;
    }

    public final int getNumber() {
        if (this != UNRECOGNIZED) {
            return this.f153049C;
        }
