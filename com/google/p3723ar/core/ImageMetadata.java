...
public class ImageMetadata {
    ...
    private final C47907m sketchEntry;
    ...
    public ImageMetadata(long j, Session session2) {
        this.session = session2;
        this.nativeHandle = j;
        this.nativeSymbolTableHandle = session2.nativeSymbolTableHandle;
        this.sketchEntry = new C47907m();
    }

    private void getMetdataEntry(int i, C47907m mVar) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        mVar.f124046a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            mVar.f124047b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            mVar.f124048c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, mVar.f124046a);
            return;
        }
    ...
    public byte getByte(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 0 && mVar.f124048c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public byte[] getByteArray(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 4 && mVar.f124048c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 2 && mVar.f124048c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public float[] getFloatArray(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 1 && mVar.f124048c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public int[] getIntArray(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C47907m mVar = this.sketchEntry;
        int i2 = mVar.f124047b;
        if (i2 == 3) {
            if (mVar.f124048c == 1) {
                long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
                nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
                return nativeGetLongFromMetadataEntry;
            }
            i2 = 3;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(mVar.f124048c)}));
    }
    ...
    public long[] getLongArray(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 5 && mVar.f124048c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        C47907m mVar = this.sketchEntry;
        if (mVar.f124047b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, mVar.f124046a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f124046a);
