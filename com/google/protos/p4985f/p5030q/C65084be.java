...
/* renamed from: com.google.protos.f.q.be */
/* compiled from: PG */
final class C65084be implements C18204ah {

    /* renamed from: a */
    private static final C65686l f176230a;
    ...
    static {
        ...
        lVar.f178472a |= 1;
        lVar.f178473b = "assistant.portable.CallHistoryContactLookupService";
        f176230a = (C65686l) kVar.build();
    }

    /* renamed from: a */
    public final C60870cx mo23683a(C18211ao aoVar, C18231d dVar, String str, C65693s sVar) {
        C65082bc bcVar = (C65082bc) aoVar;
        if (((str.hashCode() == 2024598256 && str.equals("ResolveCallHistoryContactLookup")) ? (char) 0 : 65535) == 0) {
            return C18209am.m35463a(bcVar.mo59337b((C65009av) C18214ar.m35469b(sVar, C65009av.f176050c.getParserForType())), C65083bd.f176229a, str);
        }
    ...
    public final /* bridge */ /* synthetic */ MessageLite mo23684b(C65682h hVar) {
        C65012ay ayVar = (C65012ay) C65013az.f176060c.createBuilder();
        ayVar.copyOnWrite();
        C65013az azVar = (C65013az) ayVar.instance;
        hVar.getClass();
        azVar.f176063b = hVar;
        azVar.f176062a |= 1;
        return (C65013az) ayVar.build();
    }
    ...
    public final String mo23686d(String str) {
        if (((str.hashCode() == 2024598256 && str.equals("ResolveCallHistoryContactLookup")) ? (char) 0 : 65535) == 0) {
            return "assistant.portable.CallHistoryContactLookupRequest";
        }
    ...
    public final String mo23687e(String str) {
        if (((str.hashCode() == 2024598256 && str.equals("ResolveCallHistoryContactLookup")) ? (char) 0 : 65535) == 0) {
            return "assistant.portable.CallHistoryContactLookupResponse";
        }
        throw new IllegalArgumentException("Unknown method".concat(String.valueOf(str)));
    }
}
