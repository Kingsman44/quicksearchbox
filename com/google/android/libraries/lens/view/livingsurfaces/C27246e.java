...
/* renamed from: com.google.android.libraries.lens.view.livingsurfaces.e */
/* compiled from: PG */
final class C27246e implements C2644bf {

    /* renamed from: a */
    final /* synthetic */ TextureView f74540a;

    public C27246e(TextureView textureView) {
        this.f74540a = textureView;
    }
    ...
    public final void mo6224E(C2658bt btVar) {
        int i = btVar.f7408a;
        int i2 = btVar.f7409b;
        float width = (float) this.f74540a.getWidth();
        float height = (float) this.f74540a.getHeight();
        ...
        if (f4 <= f3) {
            if (f3 > f4) {
                ...
                matrix.setScale(f3, f4, (float) ((int) (width / 2.0f)), (float) ((int) (height / 2.0f)));
                this.f74540a.setTransform(matrix);
            }
            f4 = 1.0f;
        }
        f3 = 1.0f;
        Matrix matrix2 = new Matrix();
        matrix2.setScale(f3, f4, (float) ((int) (width / 2.0f)), (float) ((int) (height / 2.0f)));
        this.f74540a.setTransform(matrix2);
    }
