...
/* renamed from: com.google.android.libraries.lens.view.ak.av */
/* compiled from: PG */
public final /* synthetic */ class C25216av implements C25240bs {

    /* renamed from: a */
    public final /* synthetic */ String f68656a;

    public /* synthetic */ C25216av(String str) {
        this.f68656a = str;
    }
    ...
    public final MessageLite mo30341a(MessageLite messageLite) {
        ...
        str.getClass();
        C62995dn dnVar = uVar2.f68777c;
        int intValue = (dnVar.containsKey(str) ? ((Integer) dnVar.get(str)).intValue() : 1) + 1;
        str.getClass();
        qVar.copyOnWrite();
        C25282u uVar3 = (C25282u) qVar.instance;
        C62995dn dnVar2 = uVar3.f68777c;
        if (!dnVar2.f170058b) {
            uVar3.f68777c = dnVar2.mo58980a();
        }
        uVar3.f68777c.put(str, Integer.valueOf(intValue));
        adVar.copyOnWrite();
