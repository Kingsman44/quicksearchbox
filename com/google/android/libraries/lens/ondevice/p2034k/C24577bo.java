...
@C24266a(mo29795a = "OcrRecognitionEngine")
/* renamed from: com.google.android.libraries.lens.ondevice.k.bo */
/* compiled from: PG */
public final class C24577bo implements C24650eg {

    /* renamed from: a */
    private final C24553ar f67266a;

    public C24577bo(C24553ar arVar) {
        this.f67266a = arVar;
    }
    ...
    public final C58833ax mo29949a(C24795f fVar) {
        ...
        return C58833ax.m90834k(C24473a.m45543b(C24553ar.m45635c(yVar), 333916028));
    }

    /* renamed from: b */
    public final void mo29950b(Context context, LodeResourceHolder lodeResourceHolder, C24803n nVar, C24795f fVar) {
        C24553ar arVar = this.f67266a;
        C24814y yVar = fVar.f67751c;
        if (yVar == null) {
            yVar = C24814y.f67826d;
        }
        arVar.mo29955d(context, yVar, nVar);
    }
    ...
    public final boolean mo29952d(C24795f fVar) {
        ...
        return arVar.mo29954b(yVar.f67829b);
    }
}
