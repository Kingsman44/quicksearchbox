...
@C24266a(mo29795a = "SensitivityClassificationEngine")
/* renamed from: com.google.android.libraries.lens.ondevice.k.fi */
/* compiled from: PG */
public final class C24679fi implements C24650eg {

    /* renamed from: a */
    final C24682fl f67504a;

    /* renamed from: b */
    final C26243ad f67505b;

    public C24679fi(C24682fl flVar, C26243ad adVar) {
        this.f67504a = flVar;
        this.f67505b = adVar;
    }
    ...
    public final C58833ax mo29949a(C24795f fVar) {
        if (this.f67505b.mo31464k(C26242ac.ENABLE_GDD_LENS_AVS_GELLER_SYNC)) {
            return C58833ax.m90834k(C24473a.m45544c("sensitivity_classifier", "GddLensAvs"));
        }
        return C58833ax.m90834k(C24473a.m45543b("model_sensitivity_classifier_v1_1", 1));
    }

    /* renamed from: b */
    public final void mo29950b(Context context, LodeResourceHolder lodeResourceHolder, C24803n nVar, C24795f fVar) {
        C24682fl flVar = this.f67504a;
        boolean k = flVar.f67511b.mo31464k(C26242ac.ENABLE_GDD_LENS_AVS_GELLER_SYNC);
        String str = "model_sensitivity_classifier_v1_1";
        String f = C24473a.m45547f(nVar, true != k ? str : "sensitivity_classifier");
        if (TextUtils.isEmpty(f)) {
            if (true == k) {
                str = "sensitivity_classifier";
            }
            throw new C24272d(str);
        }
        C19668f b = C24291a.m45355b(f);
        C62318cn cnVar = fVar.f67754f;
        if (cnVar == null) {
            cnVar = C62318cn.f168229c;
        }
        C19651b bVar = cnVar.f168232b;
        if (bVar == null) {
        ...
        cmVar.copyOnWrite();
        C62318cn cnVar2 = (C62318cn) cmVar.instance;
        bVar3.getClass();
        cnVar2.f168232b = bVar3;
        cnVar2.f168231a |= 1;
        C62318cn cnVar3 = (C62318cn) cmVar.build();
        C62350m mVar = (C62350m) C62351n.f168321c.createBuilder();
        mVar.copyOnWrite();
        C62351n nVar2 = (C62351n) mVar.instance;
        cnVar3.getClass();
        nVar2.f168324b = cnVar3;
        nVar2.f168323a = 4;
        flVar.f67510a.mo30015f(context, (C62351n) mVar.build());
    }
