...
/* renamed from: com.google.android.libraries.surveys.internal.view.cn */
/* compiled from: PG */
public final class C43139cn extends C0260w {

    /* renamed from: a */
    public static final String f112824a = "SurveySysInfoDialog-".concat("cn");
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        inflate.findViewById(R.id.survey_system_info_dialog_ok_button).setOnClickListener(new C43137cl(create));
        ...
        recyclerView.addOnScrollListener(new C43138cm(this, inflate));
