package com.google.android.libraries.search.p2871b.p2872a.p2886n;
...
/* renamed from: com.google.android.libraries.search.b.a.n.b */
/* compiled from: PG */
public final class C37213b implements C37242d {
    ...
    /* renamed from: c */
    C37243e f98868c = null;

    public C37213b() {
        HashMap hashMap = new HashMap();
        this.f98866a = hashMap;
        HashMap hashMap2 = new HashMap();
        this.f98867b = hashMap2;
        hashMap.put(0, new C37245g(0, "FLOW_TYPE_UNKNOWN"));
        hashMap.put(1, new C37245g(1, "NONE"));
        hashMap.put(101, new C37245g(101, "OPEN_WEBGLIDE_INTENT_FLOW"));
        ...
        hashMap2.put(101, new C37244f(101, "OPEN_WEBGLIDE_INTENT_STARTED"));
        hashMap2.put(102, new C37244f(102, "OPEN_WEBGLIDE_INTENT_RECEIVED"));
        hashMap2.put(103, new C37244f(103, "URL_LOAD_REQUESTED"));
        hashMap2.put(104, new C37244f(104, "URL_FIRST_CONTENTFUL_PAINT"));
        hashMap2.put(105, new C37244f(105, "URL_LOAD_FAILED"));
        hashMap2.put(106, new C37244f(106, "URL_LOAD_CANCELLED"));
        C58490gz gzVar = new C58490gz(4);
        new C58490gz(4);
        this.f98868c = new C37246h(2316, "webglide_android", "webglide", gzVar.mo55427f(true));
    }

    /* renamed from: a */
    public final C37239a mo40690a(int i) {
        Map map = this.f98867b;
        Integer valueOf = Integer.valueOf(i);
        if (map.containsKey(valueOf)) {
            return (C37239a) this.f98867b.get(valueOf);
        }
    ...
    public final C37240b mo40691b(int i) {
        C37240b bVar = (C37240b) this.f98866a.get(Integer.valueOf(i));
        if (bVar != null) {
            return bVar;
        }
