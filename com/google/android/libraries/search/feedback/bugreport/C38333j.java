...
/* renamed from: com.google.android.libraries.search.feedback.bugreport.j */
/* compiled from: PG */
public final /* synthetic */ class C38333j implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ PrintWriter f101513a;

    public /* synthetic */ C38333j(PrintWriter printWriter) {
        this.f101513a = printWriter;
    }

    public final Object apply(Object obj) {
        PrintWriter printWriter = this.f101513a;
        Map map = (Map) obj;
        if (map.isEmpty()) {
            return null;
        }
