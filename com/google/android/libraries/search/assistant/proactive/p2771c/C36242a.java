...
/* renamed from: com.google.android.libraries.search.assistant.proactive.c.a */
/* compiled from: PG */
public final class C36242a implements C32597b {

    /* renamed from: a */
    private static final C59071e f94670a = C59071e.m91332i("com.google.android.libraries.search.assistant.proactive.c.a");

    /* renamed from: b */
    private static final C32836cd f94671b;

    /* renamed from: c */
    private static final C33476a f94672c = new C33476a("assistant.api.params.AlarmParams", C51527l.f134273f);
    ...
    public final C60870cx mo38175e(C32810be beVar) {
        ((C59052c) ((C59052c) f94670a.mo56224b()).mo56372aa(52271)).mo56386p("#Start fetching alarm context");
        C32799au auVar = (C32799au) C32801aw.f87978c.createBuilder();
        C32804az azVar = (C32804az) C32806ba.f87988c.createBuilder();
        C52230ka a = f94672c.mo38879a(C51527l.f134273f);
        azVar.copyOnWrite();
