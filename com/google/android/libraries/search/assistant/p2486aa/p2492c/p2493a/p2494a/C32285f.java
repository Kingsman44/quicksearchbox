...
/* renamed from: com.google.android.libraries.search.assistant.aa.c.a.a.f */
/* compiled from: PG */
public final class C32285f implements C32287h {

    /* renamed from: a */
    private static final C59071e f86513a = C59071e.m91331h();
    ...
    public final C66709am mo38031a(C32849cq cqVar, C32801aw awVar) {
        ...
        List a = C32284e.m60065a(awVar);
        C59052c cVar = (C59052c) f86513a.mo56224b();
        cVar.mo56378ag(C58975e.f156826a, "Sbcp");
        Integer valueOf = Integer.valueOf(a.size());
        String b = C32941s.m60951b(cqVar);
        cVar.mo56379ah(new C59094n(52569));
        cVar.mo56359L("Adding %s Ngrams to the contextUpdate. SessionToken: %s; RequestId: %s", valueOf, b, (Object) null);
        ...
        a3.mo59724c();
        a3.mo59723b(C32289j.m60072a("assistant-past-typed-queries-ngrams", "$PAST_QUERIES", a));
    ...
    public final void mo38032b(C32849cq cqVar, int i, C32801aw awVar, C66721ay ayVar) {
        ...
        cVar.mo56379ah(new C59094n(52570));
        cVar.mo56359L("Adding %s Ngrams to the ASRRequest. SessionToken: %s; RequestId: %s", valueOf, b, valueOf2);
        if (!a.isEmpty()) {
            ayVar.mo59718c(C32289j.m60072a("assistant-past-typed-queries-ngrams", "$PAST_QUERIES", a));
        }
    }
}
