...
/* renamed from: com.google.android.libraries.search.assistant.performer.deviceactions.an */
/* compiled from: PG */
public final /* synthetic */ class C35885an implements C60931s {

    /* renamed from: a */
    public final /* synthetic */ String f94009a;

    public /* synthetic */ C35885an(String str) {
        this.f94009a = str;
    }

    public final C60870cx apply(Object obj) {
        String str = this.f94009a;
        Optional optional = (Optional) obj;
        C59071e eVar = C35887ap.f94011a;
        C58976aa aaVar = C58975e.f156826a;
        if (!optional.isPresent()) {
            return C60856cj.m92900i(C35887ap.m64281b(str));
        }
        Bundle bundle = (Bundle) optional.get();
        if (!bundle.containsKey("success")) {
            return C60856cj.m92900i(C36180b.m64579c(C52235kf.ABORTED, "Sunshine does not return state."));
        }
        ...
        sgVar.f137693a |= 2;
        sgVar.f137696d = z;
        if (z && bundle.containsKey("slice_uri") && !TextUtils.isEmpty(bundle.getString("slice_uri"))) {
        ...
        if (bundle.containsKey("tts_config")) {
            ...
            if (byteArray != null) {
                try {
                    ...
                    ((C59052c) ((C59052c) c).mo56372aa(51835)).mo56389s("Wrong proto marked as type %s", "tts_config");
                }
            }
        ...
        return C60856cj.m92900i(C36180b.m64577a("handle_wellbeing_results", "assistant.api.client_op.HandleWellbeingResults", seVar.build()));
    }
}
