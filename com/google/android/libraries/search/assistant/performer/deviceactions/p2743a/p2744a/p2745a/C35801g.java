...
/* renamed from: com.google.android.libraries.search.assistant.performer.deviceactions.a.a.a.g */
/* compiled from: PG */
public final class C35801g implements C35870b {

    /* renamed from: a */
    public static final C59071e f93787a = C59071e.m91332i("com.google.android.libraries.search.assistant.performer.deviceactions.a.a.a.g");

    /* renamed from: b */
    public final C35934c f93788b;

    /* renamed from: c */
    private final Context f93789c;

    /* renamed from: d */
    private C35473i f93790d;

    public C35801g(Context context, C35935d dVar) {
        this.f93789c = context;
        this.f93788b = dVar.mo39899a("device.MODIFY_SETTING");
    }
    ...
    public final C60870cx mo39851a(C52115fu fuVar) {
        ...
        C35932a.m64317b(this.f93788b, str);
        if ((fuVar.f136755a & 2) != 0) {
            int b = C52112fr.m86508b(fuVar.f136757c);
            if (b == 0) {
                b = 1;
            }
            int g = C35799e.m64194g(C35799e.m64190c(this.f93789c), b);
            if (g == 3) {
                this.f93788b.mo39896d(str, C62722b.INTERNAL);
                return C60856cj.m92900i(C36180b.m64579c(C52235kf.INTERNAL, String.format("Unable to update setting %s", new Object[]{str})));
            } else if (g == 4) {
                this.f93788b.mo39896d(str, C62722b.OK);
                return C60856cj.m92900i(C36180b.f94544a);
            } else {
                Intent putExtra = new Intent().setAction(C35787a.f93752h).addCategory(C35787a.f93748d).setPackage("com.android.settings").putExtra(C35787a.f93753i, g == 1).putExtra(C35787a.f93747c, "android-app://com.google.android.googlequicksearchbox/https/www.google.com").putExtra("IsVoiceQuery", false).putExtra("NoUiQuery", true);
                C35473i iVar = this.f93790d;
                if (iVar == null) {
                    C59104x c = f93787a.mo56225c();
                    c.mo56378ag(C58975e.f156826a, "ModifyAirplaneMode");
                    ((C59052c) ((C59052c) c).mo56372aa(52002)).mo56389s("%s", "visActivityStarter is null");
                    return C60856cj.m92900i(C36180b.m64579c(C52235kf.INTERNAL, "visActivityStarter is null"));
                }
                return C60922j.m93044g(iVar.mo20099a(putExtra), C47810es.m84963c(new C35800f(this, str)), C60826bg.f164896a);
            }
        } else {
            String format = String.format("Change is not provided for %s.", new Object[]{str});
            C59104x d = f93787a.mo56226d();
            d.mo56378ag(C58975e.f156826a, "ModifyAirplaneMode");
            ((C59052c) ((C59052c) d).mo56372aa(52004)).mo56389s("%s", format);
            this.f93788b.mo39896d(str, C62722b.INVALID_ARGUMENT);
