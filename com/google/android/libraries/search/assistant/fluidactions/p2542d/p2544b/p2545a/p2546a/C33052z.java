...
/* renamed from: com.google.android.libraries.search.assistant.fluidactions.d.b.a.a.z */
/* compiled from: PG */
public final /* synthetic */ class C33052z implements C60931s {

    /* renamed from: a */
    public final /* synthetic */ C32985ag f88505a;

    /* renamed from: b */
    public final /* synthetic */ C52623yp f88506b;

    /* renamed from: c */
    public final /* synthetic */ Map f88507c;

    /* renamed from: d */
    public final /* synthetic */ Set f88508d;

    public /* synthetic */ C33052z(C32985ag agVar, C52623yp ypVar, Map map, Set set) {
        this.f88505a = agVar;
        this.f88506b = ypVar;
        this.f88507c = map;
        this.f88508d = set;
    ...
    public final C60870cx apply(Object obj) {
        C32985ag agVar = this.f88505a;
        C52623yp ypVar = this.f88506b;
        Map map = this.f88507c;
        Set<String> set = this.f88508d;
        Optional optional = (Optional) obj;
        if (optional.isPresent()) {
            return agVar.mo38438f(ypVar, (String) optional.get());
        }
        if (set.size() == 1) {
            String str = (String) C58557jl.m90133n(set);
            agVar.f88372c.mo38462G(str);
            return agVar.mo38438f(ypVar, str);
        }
        ...
        for (String str2 : set) {
            ...
            if (map.containsKey(str2)) {
                ...
                if (valueOf.intValue() == 1) {
                    ...
                    String quantityString = agVar.f88371b.getResources().getQuantityString(R.plurals.assistantactions_n_phone_numbers, valueOf.intValue(), new Object[]{valueOf});
                    doVar.copyOnWrite();
