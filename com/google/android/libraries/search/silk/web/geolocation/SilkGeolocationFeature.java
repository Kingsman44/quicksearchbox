...
/* compiled from: PG */
public abstract class SilkGeolocationFeature implements WebFeature, C41746d {
    /* renamed from: e */
    public static WebFeature m70712e(C40788c cVar) {
        C44085c cVar2 = new C44085c();
        cVar2.mo47058c(new AutoValue_SilkGeolocationPostMessageConfig());
        cVar2.f114767d.add(SilkGeolocationMessageHandler.class);
        cVar2.mo47057b(C41726a.class, cVar.getClass());
        return new AutoValue_SilkGeolocationFeature(cVar2.mo47056a(), C40759m.m70631a(19, new Integer[0]));
    }
    ...
    public final Class mo41578c() {
        return SilkGeolocationFeature.class;
    }
