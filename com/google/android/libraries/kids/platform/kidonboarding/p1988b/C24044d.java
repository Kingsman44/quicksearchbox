...
/* renamed from: com.google.android.libraries.kids.platform.kidonboarding.b.d */
/* compiled from: PG */
public final class C24044d implements C24043c {

    /* renamed from: a */
    private final C62921ba f65709a;

    /* renamed from: b */
    private final String f65710b;

    public C24044d(C62921ba baVar, String str) {
    ...
    public final Uri mo29437a(C54618k kVar) {
        ...
        Uri.Builder buildUpon = Uri.parse(this.f65710b).buildUpon();
    ...
    public final /* bridge */ /* synthetic */ C24039b mo29438b(C69626l lVar) {
        return new C24038a(this.f65709a, lVar);
    }
}
