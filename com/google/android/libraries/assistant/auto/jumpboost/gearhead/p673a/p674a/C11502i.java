...
/* renamed from: com.google.android.libraries.assistant.auto.jumpboost.gearhead.a.a.i */
/* compiled from: PG */
final class C11502i implements C60930r {

    /* renamed from: a */
    final /* synthetic */ C11507n f37375a;

    public C11502i(C11507n nVar) {
        this.f37375a = nVar;
    }

    /* renamed from: a */
    public final C60870cx mo18058a() {
        Integer num = this.f37375a.f37385c;
        if (num != null) {
            int intValue = num.intValue();
            C8888bf bfVar = (C8888bf) this.f37375a.f37384b.mo27525b();
            ...
            C70338di diVar = C8889bg.f30849b;
            if (diVar == null) {
                synchronized (C8889bg.class) {
                    diVar = C8889bg.f30849b;
                    if (diVar == null) {
                        C70335df d = C70338di.m102603d();
                        d.f187487c = C70337dh.UNARY;
                        d.f187488d = C70338di.m102602c("wireless.android.auto.proto.assistant.CarAssistantCallbacksService", "GetSessionData");
                        d.f187489e = true;
                        d.f187485a = C70850d.m103697c(C8884bb.f30842c);
                        d.f187486b = C70850d.m103697c(C8893bk.f30858l);
                        diVar = d.mo62040a();
                        C8889bg.f30849b = diVar;
                    }
                }
            }
            return C70876o.m103760a(jVar.mo39510a(diVar, bfVar.f189040b), a2);
        }
        throw new C11528g("Error getting session data");
    }
}
