...
/* renamed from: com.google.android.libraries.assistant.auto.tng.suggestions.datastore.room.u */
/* compiled from: PG */
final class C16177u extends C3965r {
    public C16177u(C3925ah ahVar) {
        super(ahVar);
    }
    ...
    public final /* bridge */ /* synthetic */ void mo8303a(C4057l lVar, Object obj) {
        ...
        if (nVar.mo22752f() == null) {
            ...
            lVar.mo8206g(8, nVar.mo22752f());
        }
    }

    /* renamed from: f */
    public final String mo8214f() {
        return "UPDATE OR REPLACE `candidate_suggestion` SET `id` = ?,`display_text` = ?,`description` = ?,`locale` = ?,`source` = ?,`created_time_ms` = ?,`metadata` = ? WHERE `id` = ?";
    }
}
