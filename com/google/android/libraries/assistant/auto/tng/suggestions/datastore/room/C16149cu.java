...
/* renamed from: com.google.android.libraries.assistant.auto.tng.suggestions.datastore.room.cu */
/* compiled from: PG */
final class C16149cu extends C3965r {
    public C16149cu(C3925ah ahVar) {
        super(ahVar);
    }
    ...
    public final /* bridge */ /* synthetic */ void mo8303a(C4057l lVar, Object obj) {
        ...
        if (coVar.mo22804h() == null) {
            ...
            lVar.mo8206g(10, coVar.mo22804h());
        }
    }

    /* renamed from: f */
    public final String mo8214f() {
        return "UPDATE OR ABORT `suggestion_to_display` SET `id` = ?,`candidate_suggestion_id` = ?,`display_id` = ?,`is_displayed_now` = ?,`display_text` = ?,`description` = ?,`display_metadata` = ?,`source` = ?,`action_fulfillment_data` = ? WHERE `id` = ?";
    }
}
