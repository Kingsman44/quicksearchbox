...
/* renamed from: com.google.android.libraries.assistant.auto.tng.suggestions.datastore.room.cj */
/* compiled from: PG */
final class C16138cj extends C3937a {
    public C16138cj() {
        super(8, 9);
    }
    ...
    public final void mo8220a(C4049d dVar) {
        ...
        dVar2.f12902a.execSQL("DELETE FROM `candidate_suggestion_metrics`");
        ...
        dVar2.f12902a.execSQL("CREATE TABLE IF NOT EXISTS `suggestion_to_display` (`id` TEXT NOT NULL, `candidate_suggestion_id` TEXT NOT NULL, `display_id` TEXT NOT NULL, `is_displayed_now` INTEGER NOT NULL, `display_text` TEXT NOT NULL, `description` TEXT, `display_metadata` BLOB NOT NULL, `source` INTEGER NOT NULL, `action_fulfillment_data` BLOB NOT NULL, PRIMARY KEY(`id`), FOREIGN KEY(`candidate_suggestion_id`) REFERENCES `candidate_suggestion`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE , FOREIGN KEY(`display_id`) REFERENCES `display_info`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
