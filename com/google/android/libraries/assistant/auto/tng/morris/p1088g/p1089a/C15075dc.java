...
/* renamed from: com.google.android.libraries.assistant.auto.tng.morris.g.a.dc */
/* compiled from: PG */
public final /* synthetic */ class C15075dc implements View.OnClickListener {

    /* renamed from: a */
    public final /* synthetic */ C15084dl f45236a;

    public /* synthetic */ C15075dc(C15084dl dlVar) {
        this.f45236a = dlVar;
    }

    public final void onClick(View view) {
        C14986h hVar = this.f45236a.f45246b;
        C14371gt gtVar = (C14371gt) C14492lf.f43796e.createBuilder();
        C14478ks ksVar = (C14478ks) C14479kt.f43760e.createBuilder();
        ksVar.copyOnWrite();
        ((C14479kt) ksVar.instance).f43763b = 11;
        gtVar.copyOnWrite();
