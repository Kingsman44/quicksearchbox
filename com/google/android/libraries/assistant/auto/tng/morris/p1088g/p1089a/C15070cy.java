...
/* renamed from: com.google.android.libraries.assistant.auto.tng.morris.g.a.cy */
/* compiled from: PG */
public final /* synthetic */ class C15070cy implements CompoundButton.OnCheckedChangeListener {

    /* renamed from: a */
    public final /* synthetic */ C15084dl f45230a;

    public /* synthetic */ C15070cy(C15084dl dlVar) {
        this.f45230a = dlVar;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        C15084dl dlVar = this.f45230a;
        C14986h hVar = dlVar.f45246b;
        C14371gt gtVar = (C14371gt) C14492lf.f43796e.createBuilder();
        C14478ks ksVar = (C14478ks) C14479kt.f43760e.createBuilder();
        ksVar.copyOnWrite();
        ((C14479kt) ksVar.instance).f43763b = 17;
        ksVar.copyOnWrite();
        C14479kt ktVar = (C14479kt) ksVar.instance;
        ktVar.f43762a |= 1;
        ktVar.f43764c = z;
        gtVar.copyOnWrite();
        C14492lf lfVar = (C14492lf) gtVar.instance;
        C14479kt ktVar2 = (C14479kt) ksVar.build();
        ktVar2.getClass();
        lfVar.f43801d = ktVar2;
        lfVar.f43800c = 17;
