...
/* renamed from: com.google.android.libraries.assistant.trainingcache.c.g */
/* compiled from: PG */
public final class C19446g {

    /* renamed from: a */
    private static final C59071e f54377a = C59071e.m91332i("com.google.android.libraries.assistant.trainingcache.c.g");

    /* renamed from: a */
    public static C58485gu m37137a(C67270aa aaVar, C67305bi biVar, int i) {
        ...
        try {
            ...
            for (C67359w wVar : ekhoEventReader.mo24632a(i)) {
                e.mo55395g((C67335cl) C62942bv.parseFrom((C62942bv) C67335cl.f183020b, wVar.f183091c, C62921ba.m95368a()));
            }
        } catch (C62974ct e2) {
            ((C59052c) ((C59052c) ((C59052c) f54377a.mo56226d()).mo56382g(e2)).mo56372aa(47865)).mo56386p("Failed to process speech learning task result.");
        } catch (Throwable th) {
            try {
