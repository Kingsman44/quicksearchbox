...
/* renamed from: com.google.android.libraries.assistant.c.g.a.a.a.v */
/* compiled from: PG */
final class C17354v implements C2644bf {

    /* renamed from: a */
    final /* synthetic */ C17355w f50200a;

    public C17354v(C17355w wVar) {
        this.f50200a = wVar;
    }
    ...
    public final void mo6241p(int i) {
        if (i == 4) {
            this.f50200a.mo23297e((Throwable) null, "[onPlaybackStateChanged][STATE_ENDED]");
        }
    }
    ...
    public final void mo6243r(C2639ba baVar) {
        this.f50200a.mo23297e(baVar, "[onPlayerError]");
    }
