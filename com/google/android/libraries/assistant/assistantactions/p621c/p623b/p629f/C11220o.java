...
/* renamed from: com.google.android.libraries.assistant.assistantactions.c.b.f.o */
/* compiled from: PG */
public final class C11220o {

    /* renamed from: a */
    public static final /* synthetic */ int f36631a = 0;

    /* renamed from: b */
    private static final Pattern f36632b = Pattern.compile("\\p{Punct}*");

    /* renamed from: b */
    private static boolean m26603b(String str) {
        return !TextUtils.isEmpty(str) && f36632b.matcher(str).matches();
    }

    /* renamed from: a */
    public static C48339n m26602a(String str, String str2) {
            ...
            if (i == 0) {
                ...
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        arrayList.add(new C11219n(4, str3, str3));
                    }
                } else if (arrayList.isEmpty() || ((C11219n) C58557jl.m90131l(arrayList)).f36630c != 2) {
                    arrayList.add(new C11219n(1, BuildConfig.FLAVOR, aVar.f191346a));
                } else {
                    ((C11219n) C58557jl.m90131l(arrayList)).f36630c = 3;
                    ((C11219n) C58557jl.m90131l(arrayList)).f36629b = aVar.f191346a;
                }
            } else if (arrayList.isEmpty() || ((C11219n) C58557jl.m90131l(arrayList)).f36630c != 1) {
                arrayList.add(new C11219n(2, aVar.f191346a, BuildConfig.FLAVOR));
            } else {
                ((C11219n) C58557jl.m90131l(arrayList)).f36630c = 3;
                ((C11219n) C58557jl.m90131l(arrayList)).f36628a = aVar.f191346a;
            }
        }
        ...
        for (int i5 = 0; i5 < size; i5++) {
            C11219n nVar = (C11219n) arrayList.get(i5);
            C48332g gVar = (C48332g) C48333h.f124978e.createBuilder();
            int size2 = C58869cf.m90936b(new C58903m(' ')).mo56152f(C58911u.f156751b).mo56151a().mo56155i(nVar.f36629b.trim()).size();
            gVar.copyOnWrite();
            ((C48333h) gVar.instance).f124981b = size2;
            gVar.copyOnWrite();
            ((C48333h) gVar.instance).f124980a = i3;
            int length = nVar.f36629b.length();
            gVar.copyOnWrite();
            ...
            int size3 = C58869cf.m90936b(new C58903m(' ')).mo56152f(C58911u.f156751b).mo56151a().mo56155i(nVar.f36628a.trim()).size();
            gVar2.copyOnWrite();
            ((C48333h) gVar2.instance).f124981b = size3;
            gVar2.copyOnWrite();
            ((C48333h) gVar2.instance).f124980a = i4;
            int length2 = nVar.f36628a.length();
            gVar2.copyOnWrite();
            ...
            boolean z = nVar.f36630c != 4;
            fVar.copyOnWrite();
            ((C48334i) fVar.instance).f124986a = z;
            eVar.mo53152a((C48334i) fVar.build());
            i4 += nVar.f36628a.length();
            i3 += nVar.f36629b.length();
        }
        C48337l lVar = (C48337l) C48338m.f124994d.createBuilder();
        StringBuilder sb = new StringBuilder();
        for (char c : str.toCharArray()) {
            if (m26603b(String.valueOf(c))) {
                sb.append(c);
            }
        }
        StringBuilder sb2 = new StringBuilder();
        for (char c2 : str2.toCharArray()) {
            if (m26603b(String.valueOf(c2))) {
                sb2.append(c2);
            }
        }
        int sum = Collection.EL.stream(new C71818b().mo63056f(sb.toString(), sb2.toString())).filter(C11217l.f36626a).mapToInt(C11218m.f36627a).sum();
        ...
        for (char c3 : str.toCharArray()) {
            if (!m26603b(String.valueOf(c3))) {
                sb3.append(c3);
            }
        }
        StringBuilder sb4 = new StringBuilder();
        for (char c4 : str2.toCharArray()) {
            if (!m26603b(String.valueOf(c4))) {
                sb4.append(c4);
            }
        }
        ...
        int sum2 = Collection.EL.stream(arrayList).filter(C11215j.f36624a).mapToInt(C11216k.f36625a).sum();
        ...
        int sum3 = Collection.EL.stream(arrayList).filter(C11213h.f36622a).mapToInt(C11214i.f36623a).sum();
