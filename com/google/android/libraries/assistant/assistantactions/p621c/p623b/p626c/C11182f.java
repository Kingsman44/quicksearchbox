...
/* renamed from: com.google.android.libraries.assistant.assistantactions.c.b.c.f */
/* compiled from: PG */
public final class C11182f implements C11204b {

    /* renamed from: a */
    public static final C59071e f36574a = C59071e.m91332i("com.google.android.libraries.assistant.assistantactions.c.b.c.f");

    /* renamed from: b */
    public static final C58528ij f36575b = C58528ij.m90011K("ui.SHOW_TEXT", "ui.SHOW_NATIVE_FORM");
    ...
    /* renamed from: e */
    final C11059d f36578e;

    /* renamed from: f */
    final PackageManager f36579f;

    /* renamed from: g */
    final C60887da f36580g;

    /* renamed from: h */
    public C51950fc f36581h = C51950fc.FORM_UI_THEME_DEFAULT;

    /* renamed from: i */
    public final C11228a f36582i;

    public C11182f(C11059d dVar, PackageManager packageManager, C11228a aVar, C60887da daVar) {
        this.f36578e = dVar;
        this.f36579f = packageManager;
        this.f36580g = daVar;
        this.f36582i = aVar;
    }
    ...
    /* renamed from: b */
    public final void mo19614b(String str) {
        C60856cj.m92911t(this.f36578e.mo19527a("fluid_actions_alarm_preferred_app_package_name", str), new C11181e(), C60826bg.f164896a);
    }
    ...
    public final C60870cx mo19605d(Context context, C52081en enVar, C11054a aVar) {
        ...
        this.f36577d = uhVar;
        C51936ep a2 = C51936ep.m86435a(this.f36576c.f136323g);
        if (a2 == null) {
            a2 = C51936ep.DEFAULT;
        }
        if (a2 != C51936ep.ALARM) {
            return C60856cj.m92900i(C58836b.f156633a);
        }
        if (this.f36577d.f137840a.size() != 1) {
            return C60856cj.m92900i(C58836b.f156633a);
        }
        this.f36582i.mo19632b();
        C51950fc a3 = C51950fc.m86447a(this.f36576c.f136324h);
        if (a3 == null) {
            a3 = C51950fc.FORM_UI_THEME_DEFAULT;
        }
        this.f36581h = a3;
        C51805du duVar = (C51805du) b.mo56107c();
        C52490tr trVar = (C52490tr) C58557jl.m90133n(this.f36577d.f137840a);
        ...
        if (trVar.f137798b == 9 && (trVar.f137797a & 1) != 0 && ((C52475tc) trVar.f137799c).f137747b) {
            C58833ax g = C11222q.m26610g(trVar.f137800d, this.f36576c);
            if (g.mo56113h() && ((C51941eu) g.mo56107c()).f136277e == 17) {
                ...
                if (a4 == C50931ac.CONFIRM) {
                    ...
                    C51953ff ffVar2 = this.f36576c;
                    C58833ax g2 = C11222q.m26610g("clock_app_picker_field", ffVar2);
                    if (!g2.mo56113h() || ((C51941eu) g2.mo56107c()).f136277e != 17) {
                        ((C59052c) ((C59052c) f36574a.mo56224b()).mo56372aa(43060)).mo56386p("getSelectedAppIconIdentifier: ClockAppPickerField is absent.");
                        cxVar2 = C11185i.m26511b(this.f36579f, new Intent("android.intent.action.SET_ALARM"), this.f36578e, "fluid_actions_alarm_preferred_app_package_name", this.f36580g);
                    } else {
                    ...
                    cxVar = C60922j.m93044g(C60922j.m93044g(cxVar2, new C11180d(this, ffVar2), this.f36580g), new C11137a(this, a5, context), this.f36580g);
                    return C60922j.m93044g(C60922j.m93044g(cxVar, new C11179c(this, enVar, trVar, context, duVar), this.f36580g), new C11164b(this), this.f36580g);
                }
            }
        }
