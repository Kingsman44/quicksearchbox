...
/* renamed from: com.google.android.libraries.assistant.assistantactions.c.b.a.v */
/* compiled from: PG */
public final /* synthetic */ class C11131v implements C60931s {

    /* renamed from: a */
    public final /* synthetic */ C11070af f36484a;

    /* renamed from: b */
    public final /* synthetic */ C52623yp f36485b;

    /* renamed from: c */
    public final /* synthetic */ Map f36486c;

    /* renamed from: d */
    public final /* synthetic */ Set f36487d;

    public /* synthetic */ C11131v(C11070af afVar, C52623yp ypVar, Map map, Set set) {
        this.f36484a = afVar;
        this.f36485b = ypVar;
        this.f36486c = map;
        this.f36487d = set;
    ...
    public final C60870cx apply(Object obj) {
        C11070af afVar = this.f36484a;
        C52623yp ypVar = this.f36485b;
        Map map = this.f36486c;
        Set<String> set = this.f36487d;
        C58833ax axVar = (C58833ax) obj;
        if (axVar.mo56113h()) {
            return afVar.mo19542i(ypVar, (String) axVar.mo56107c());
        }
        if (set.size() == 1) {
            String str = (String) C58557jl.m90133n(set);
            afVar.f36334c.mo19561G(str);
            return afVar.mo19542i(ypVar, str);
        }
        ...
        for (String str2 : set) {
            ...
            if (map.containsKey(str2)) {
                ...
                if (valueOf.intValue() == 1) {
                    ...
                    String quantityString = afVar.f36333b.getResources().getQuantityString(R.plurals.assistantactions_n_phone_numbers, valueOf.intValue(), new Object[]{valueOf});
                    doVar.copyOnWrite();
