...
import com.google.android.libraries.assistant.assistantactions.p621c.p623b.p629f.C11221p;
import com.google.android.libraries.assistant.assistantactions.p636e.C11277g;
...
/* renamed from: com.google.android.libraries.assistant.assistantactions.c.b.a.bj */
/* compiled from: PG */
final class C11101bj implements C11078an {

    /* renamed from: a */
    private static final C59071e f36383a = C59071e.m91332i("com.google.android.libraries.assistant.assistantactions.c.b.a.bj");

    /* renamed from: b */
    private final C11073ai f36384b;

    public C11101bj(C11073ai aiVar) {
        this.f36384b = aiVar;
    }

    /* renamed from: P */
    private final C58833ax m26272P() {
        C61752n nVar;
        C61758t tVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (!axVar.mo56113h()) {
            return C58836b.f156633a;
        }
        C61748j jVar = (C61748j) axVar.mo56107c();
        if (jVar.f166802a == 2) {
            nVar = (C61752n) jVar.f166803b;
        } else {
            nVar = C61752n.f166808f;
        }
        Optional findFirst = Collection.EL.stream(nVar.f166812c).filter(C11085au.f36364a).findFirst();
    ...
    /* renamed from: Q */
    private final C58833ax m26273Q() {
        C61752n nVar;
        C63565b bVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (!axVar.mo56113h()) {
    ...
    public final void mo19555A() {
        ...
        if (axVar.mo56113h()) {
            ...
            if (Collection.EL.stream(nVar.f166812c).filter(C11079ao.f36358a).findFirst().isPresent()) {
                if (jVar.f166802a == 2) {
                ...
                mVar.mo58183b((Iterable) Collection.EL.stream(nVar3.f166812c).filter(C11090az.f36369a).collect(Collectors.toList()));
                ...
                jVar2.f166802a = 2;
                this.f36384b.f36353d = C58833ax.m90834k((C61748j) iVar.build());
            }
        }
    }
    ...
    public final void mo19556B() {
        ...
        if (axVar.mo56113h()) {
            ...
            if (Collection.EL.stream(nVar.f166812c).filter(C11089ay.f36368a).findFirst().isPresent()) {
                if (jVar.f166802a == 2) {
                    nVar2 = (C61752n) jVar.f166803b;
                } else {
                    nVar2 = C61752n.f166808f;
                ...
                mVar.mo58183b((Iterable) Collection.EL.stream(nVar3.f166812c).filter(C11092ba.f36374a).collect(Collectors.toList()));
                C61747i iVar = (C61747i) jVar.toBuilder();
                C61752n nVar4 = (C61752n) mVar.build();
                iVar.copyOnWrite();
                C61748j jVar2 = (C61748j) iVar.instance;
    ...
    /* renamed from: C */
    public final void mo19557C() {
        C58833ax axVar;
        C59071e eVar = f36383a;
        ((C59052c) ((C59052c) eVar.mo56226d()).mo56372aa(42975)).mo56386p("storeRelationshipWithCallee");
        C58833ax s = mo19588s();
        C58833ax Q = m26273Q();
        if (!s.mo56113h() || !Q.mo56113h()) {
            ((C59052c) ((C59052c) eVar.mo56226d()).mo56372aa(42976)).mo56386p("!selectedPersonNameOptional.isPresent() || !modelPersonOptional.isPresent()");
            return;
        }
        String str = (String) s.mo56107c();
        C58833ax Q2 = m26273Q();
        if (!Q2.mo56113h()) {
            axVar = C58836b.f156633a;
        } else {
            Optional findFirst = Collection.EL.stream(((C63565b) Q2.mo56107c()).f171941g).map(C11081aq.f36360a).filter(new C11082ar(str)).findFirst();
            axVar = findFirst.isPresent() ? C58833ax.m90834k((C45632al) findFirst.get()) : C58836b.f156633a;
        }
        if (!axVar.mo56113h()) {
            ((C59052c) ((C59052c) eVar.mo56226d()).mo56372aa(42978)).mo56386p("recipientPersonOptional not present");
            return;
        }
        C56359i iVar = (C56359i) C56364n.f150310j.createBuilder();
        C45632al alVar = (C45632al) axVar.mo56107c();
        iVar.copyOnWrite();
        C56364n nVar = (C56364n) iVar.instance;
        alVar.getClass();
        nVar.f150314c = alVar;
        nVar.f150312a |= 16;
        C63564a aVar = (C63564a) ((C63565b) Q.mo56107c()).toBuilder();
        aVar.copyOnWrite();
        ...
        C19045c cVar = new C19045c(this.f36384b.mo19552a(), "Store_person_name");
        if (!cVar.f53449b) {
            ((C59052c) ((C59052c) eVar.mo56226d()).mo56372aa(42977)).mo56386p("Store_person_name intent not found");
            return;
        }
        ...
        this.f36384b.mo19554c(cVar.mo24270b(this.f36384b.mo19552a()));
    }

    /* renamed from: D */
    public final /* synthetic */ void mo19558D(C51401gi giVar) {
        C11077am.m26205l(this, giVar);
    }

    /* renamed from: E */
    public final /* synthetic */ void mo19559E() {
        C11077am.m26206m(this);
    }

    /* renamed from: F */
    public final void mo19560F(String str) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            ...
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11100bi(mVar)).findFirst();
            if (findFirst.isPresent()) {
            ...
            jVar6.f166802a = 2;
            this.f36384b.f36353d = C58833ax.m90834k((C61748j) iVar3.build());
        }
    }

    /* renamed from: G */
    public final void mo19561G(String str) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            ...
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11098bg(mVar)).findFirst();
            if (findFirst.isPresent()) {
            ...
            jVar4.f166802a = 2;
            this.f36384b.f36353d = C58833ax.m90834k((C61748j) iVar2.build());
        }
    }

    /* renamed from: H */
    public final void mo19562H(String str) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            ...
            hVar4.f166793a |= 4;
            C61746h hVar5 = (C61746h) gVar.build();
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11094bc(mVar)).findFirst();
            if (findFirst.isPresent()) {
                mVar.mo58188g(findFirst.getAsInt(), hVar5);
            } else {
                mVar.mo58185d(hVar5);
    ...
    /* renamed from: I */
    public final void mo19563I(String str) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            ...
            hVar2.f166793a |= 4;
            C61746h hVar3 = (C61746h) gVar.build();
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11093bb(mVar)).findFirst();
            if (findFirst.isPresent()) {
                mVar.mo58188g(findFirst.getAsInt(), hVar3);
            } else {
                mVar.mo58185d(hVar3);
    ...
    /* renamed from: J */
    public final void mo19564J(String str) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            String str2 = (String) ((C58723pp) C11221p.f36633a).f156468c.get(str);
            if (str2 == null) {
                ((C59052c) ((C59052c) f36383a.mo56225c()).mo56372aa(42979)).mo56389s("Cannot find mid for Provider Package Name = %s", str);
                return;
            }
            if (jVar.f166802a == 2) {
                nVar = (C61752n) jVar.f166803b;
            ...
            hVar2.f166793a |= 4;
            C61746h hVar3 = (C61746h) gVar.build();
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11087aw(mVar)).findFirst();
            if (findFirst.isPresent()) {
                mVar.mo58188g(findFirst.getAsInt(), hVar3);
            } else {
                mVar.mo58185d(hVar3);
    ...
    /* renamed from: K */
    public final void mo19565K(ade ade) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            ...
            hVar2.f166793a |= 4;
            C61746h hVar3 = (C61746h) gVar.build();
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11083as(mVar)).findFirst();
            if (findFirst.isPresent()) {
                mVar.mo58188g(findFirst.getAsInt(), hVar3);
            } else {
                mVar.mo58185d(hVar3);
    ...
    /* renamed from: L */
    public final void mo19566L(String str) {
        C61752n nVar;
        C63565b bVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            ...
            C61751m mVar = (C61751m) nVar.toBuilder();
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11096be(mVar)).findFirst();
            if (!findFirst.isPresent()) {
                ((C59052c) ((C59052c) f36383a.mo56225c()).mo56372aa(42980)).mo56386p("Failed to update selected person name. Missing argument proto named person");
                return;
            }
    ...
    /* renamed from: M */
    public final void mo19567M(String str, String str2) {
        C61752n nVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (axVar.mo56113h()) {
            C61748j jVar = (C61748j) axVar.mo56107c();
            ...
            hVar4.f166793a |= 4;
            C61746h hVar5 = (C61746h) gVar.build();
            OptionalInt findFirst = IntStream.CC.range(0, ((C61752n) mVar.instance).f166812c.size()).filter(new C11086av(mVar)).findFirst();
            if (findFirst.isPresent()) {
                mVar.mo58188g(findFirst.getAsInt(), hVar5);
            } else {
                mVar.mo58185d(hVar5);
    ...
    /* renamed from: N */
    public final boolean mo19568N() {
        return ((String) m26272P().mo56109e(BuildConfig.FLAVOR)).equals("/m/02p1fkx");
    }

    /* renamed from: O */
    public final boolean mo19569O() {
        C58833ax axVar;
        C61752n nVar;
        C61758t tVar;
        if (!((String) m26272P().mo56109e(BuildConfig.FLAVOR)).equals("/m/0jzgd")) {
            return false;
        }
        C58833ax axVar2 = this.f36384b.f36353d;
        if (!axVar2.mo56113h()) {
            axVar = C58836b.f156633a;
        } else {
            C61748j jVar = (C61748j) axVar2.mo56107c();
            if (jVar.f166802a == 2) {
                nVar = (C61752n) jVar.f166803b;
            } else {
                nVar = C61752n.f166808f;
            }
            Optional findFirst = Collection.EL.stream(nVar.f166812c).filter(C11095bd.f36377a).findFirst();
            if (findFirst.isPresent()) {
                C61748j jVar2 = ((C61746h) findFirst.get()).f166797e;
                if (jVar2 == null) {
                    jVar2 = C61748j.f166800d;
                ...
                String str = tVar.f166826a == 1 ? (String) tVar.f166827b : BuildConfig.FLAVOR;
                axVar = str.isEmpty() ? C58836b.f156633a : C58833ax.m90834k(str);
            } else {
                axVar = C58836b.f156633a;
            }
        }
        if (((String) axVar.mo56109e(BuildConfig.FLAVOR)).equals("/m/07z4p")) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: a */
    public final C11073ai mo19570a() {
        return this.f36384b;
    }

    /* renamed from: b */
    public final C51936ep mo19571b() {
        C19045c cVar = new C19045c(this.f36384b.mo19552a(), "Initiate_call");
        if (cVar.f53449b) {
        ...
        ((C59052c) ((C59052c) f36383a.mo56225c()).mo56372aa(42974)).mo56386p("Cannot identify feature type");
        return C51936ep.DEFAULT;
    }

    /* renamed from: c */
    public final /* synthetic */ C58833ax mo19572c() {
        return C11077am.m26194a(this);
    }

    /* renamed from: d */
    public final /* synthetic */ C58833ax mo19573d() {
        return C11077am.m26195b(this);
    }

    /* renamed from: e */
    public final C58833ax mo19574e() {
        if (mo19582m().mo56113h()) {
            C52373pi piVar = (C52373pi) C52374pj.f137434e.createBuilder();
            String str = (String) mo19582m().mo56107c();
            piVar.copyOnWrite();
            C52374pj pjVar = (C52374pj) piVar.instance;
            str.getClass();
            pjVar.f137437b = 2;
            pjVar.f137438c = str;
            String str2 = (String) mo19582m().mo56107c();
            piVar.copyOnWrite();
            C52374pj pjVar2 = (C52374pj) piVar.instance;
            str2.getClass();
            pjVar2.f137436a |= 256;
            pjVar2.f137439d = str2;
            return C58833ax.m90834k((C52374pj) piVar.build());
        } else if (mo19578i().mo56113h()) {
            C52373pi piVar2 = (C52373pi) C52374pj.f137434e.createBuilder();
            String str3 = (String) mo19578i().mo56107c();
            piVar2.copyOnWrite();
            C52374pj pjVar3 = (C52374pj) piVar2.instance;
            str3.getClass();
            pjVar3.f137437b = 1;
            pjVar3.f137438c = str3;
            String str4 = (String) mo19578i().mo56107c();
            piVar2.copyOnWrite();
            C52374pj pjVar4 = (C52374pj) piVar2.instance;
            str4.getClass();
            pjVar4.f137436a |= 256;
            pjVar4.f137439d = str4;
            return C58833ax.m90834k((C52374pj) piVar2.build());
        } else if (!mo19592w().mo56113h()) {
            return C58836b.f156633a;
        } else {
            C52373pi piVar3 = (C52373pi) C52374pj.f137434e.createBuilder();
            String str5 = (String) mo19592w().mo56107c();
            piVar3.copyOnWrite();
            ...
            return C58833ax.m90834k((C52374pj) piVar3.build());
        }
    }

    /* renamed from: f */
    public final /* synthetic */ C58833ax mo19575f() {
        return C11077am.m26196c(this);
    }

    /* renamed from: g */
    public final /* synthetic */ C58833ax mo19576g() {
        return C11077am.m26197d(this);
    }

    /* renamed from: h */
    public final /* synthetic */ C58833ax mo19577h() {
        return C11077am.m26198e(this);
    }
    ...
    public final com.google.common.base.C58833ax mo19578i() {
        /*
            r8 = this;
            com.google.android.libraries.assistant.assistantactions.c.b.a.ai r0 = r8.f36384b
            com.google.common.base.ax r0 = r0.f36353d
        ...
        L_0x001f:
            ...
            com.google.android.libraries.assistant.assistantactions.c.b.a.at r1 = com.google.android.libraries.assistant.assistantactions.p621c.p623b.p624a.C11084at.f36363a
        ...
        L_0x00f3:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.assistant.assistantactions.p621c.p623b.p624a.C11101bj.mo19578i():com.google.common.base.ax");
    }

    /* renamed from: j */
    public final /* synthetic */ C58833ax mo19579j() {
        return C11077am.m26199f(this);
    }

    /* renamed from: k */
    public final C58833ax mo19580k() {
        C61752n nVar;
        C61758t tVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (!axVar.mo56113h()) {
        ...
        Optional findFirst = Collection.EL.stream(nVar.f166812c).filter(C11088ax.f36367a).findFirst();
        if (!findFirst.isPresent()) {
            return C58836b.f156633a;
        }
        C61748j jVar2 = ((C61746h) findFirst.get()).f166797e;
    ...
    /* renamed from: l */
    public final /* synthetic */ C58833ax mo19581l() {
        return C11077am.m26200g(this);
    }
    ...
    /* renamed from: m */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final com.google.common.base.C58833ax mo19582m() {
        /*
            r8 = this;
            com.google.android.libraries.assistant.assistantactions.c.b.a.ai r0 = r8.f36384b
            com.google.common.base.ax r0 = r0.f36353d
        ...
        L_0x001f:
            com.google.protobuf.cq r0 = r0.f166812c
            j$.util.stream.Stream r0 = p3186j$.util.Collection.EL.stream(r0)
            com.google.android.libraries.assistant.assistantactions.c.b.a.bh r1 = com.google.android.libraries.assistant.assistantactions.p621c.p623b.p624a.C11099bh.f36381a
            j$.util.stream.Stream r0 = r0.filter(r1)
            j$.util.Optional r0 = r0.findFirst()
            boolean r1 = r0.isPresent()
            if (r1 != 0) goto L_0x0038
        ...
        L_0x00f3:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.assistant.assistantactions.p621c.p623b.p624a.C11101bj.mo19582m():com.google.common.base.ax");
    }

    /* renamed from: n */
    public final /* synthetic */ C58833ax mo19583n(List list) {
        return C11077am.m26201h(this, list);
    }

    /* renamed from: o */
    public final /* synthetic */ C58833ax mo19584o() {
        return C11077am.m26202i(this);
    }

    /* renamed from: p */
    public final C58833ax mo19585p() {
        C58833ax r = mo19587r();
        if (!r.mo56113h() || ((String) r.mo56107c()).isEmpty()) {
            return C58836b.f156633a;
        }
        C51055es esVar = (C51055es) C51058ev.f132941o.createBuilder();
        String str = (String) r.mo56107c();
        esVar.copyOnWrite();
        ...
        ghVar.f133012b = 1;
        return C58833ax.m90834k((C51098gh) ggVar.build());
    }

    /* renamed from: q */
    public final C58833ax mo19586q() {
        C61752n nVar;
        C61758t tVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (!axVar.mo56113h()) {
        ...
        for (C61746h hVar : nVar.f166812c) {
            if (hVar.f166796d.equals("provider_mimetype")) {
                ...
                return C58833ax.m90834k(tVar.f166826a == 1 ? (String) tVar.f166827b : BuildConfig.FLAVOR);
            }
        }
        return C58836b.f156633a;
    }
    ...
    /* renamed from: r */
    public final C58833ax mo19587r() {
        C61752n nVar;
        C61758t tVar;
        C58833ax axVar = this.f36384b.f36353d;
        if (!axVar.mo56113h()) {
        ...
        for (C61746h hVar : nVar.f166812c) {
            if (hVar.f166796d.equals("provider")) {
                ...
                return C58833ax.m90833j((String) C11221p.f36633a.get(tVar.f166826a == 1 ? (String) tVar.f166827b : BuildConfig.FLAVOR));
            }
        }
        return C58836b.f156633a;
    }
    ...
    /* renamed from: s */
    public final C58833ax mo19588s() {
        C58833ax Q = m26273Q();
        return (!Q.mo56113h() || ((C63565b) Q.mo56107c()).f171939e.isEmpty()) ? C58836b.f156633a : C58833ax.m90834k(((C63565b) Q.mo56107c()).f171939e);
    }

    /* renamed from: t */
    public final C58833ax mo19589t(String str, String str2) {
        C58833ax Q = m26273Q();
        if (!Q.mo56113h()) {
            return C58836b.f156633a;
        }
        C62971cq<C56364n> cqVar = ((C63565b) Q.mo56107c()).f171941g;
                    ...
                    if (it.hasNext()) {
                        if (((C45626af) it.next()).f120006c.equals(str)) {
                            ...
                            if (cVar.f150293a.equals(str2) && (nVar.f150312a & 16) != 0) {
                                ...
                                return C58833ax.m90834k(C11277g.m26767b(alVar2));
                            }
                        }
                    }
                }
            ...
            while (true) {
                if (it2.hasNext()) {
                    if (((C45626af) it2.next()).f120006c.equals(str) && (nVar2.f150312a & 16) != 0) {
                        ...
                        return C58833ax.m90834k(C11277g.m26767b(alVar4));
                    }
                }
            }
        }
    ...
    /* renamed from: u */
    public final C58833ax mo19590u(String str, String str2) {
        C58833ax Q = m26273Q();
        if (!Q.mo56113h()) {
            return C58836b.f156633a;
        }
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (((C45626af) it.next()).f120006c.equals(str)) {
                            ...
                            if (cVar.f150293a.equals(str2) && (nVar.f150312a & 16) != 0) {
                                return C58833ax.m90834k(C11277g.m26769d(nVar));
                            }
                        }
                    }
                }
        ...
        for (C56364n nVar2 : cqVar) {
            ...
            while (true) {
                if (it2.hasNext()) {
                    if (((C45626af) it2.next()).f120006c.equals(str) && (nVar2.f150312a & 16) != 0) {
                        return C58833ax.m90834k(C11277g.m26769d(nVar2));
                    }
                }
            }
        }
    ...
    /* renamed from: v */
    public final C58833ax mo19591v() {
        C58833ax w = mo19592w();
        C58833ax s = mo19588s();
        if (!w.mo56113h() || !s.mo56113h()) {
            return C58836b.f156633a;
        }
        C58833ax t = mo19589t((String) s.mo56107c(), BuildConfig.FLAVOR);
        if (!t.mo56113h()) {
            return C58836b.f156633a;
        }
        ...
        for (C52617yj yjVar : ytVar.f138179b) {
            ...
            while (true) {
                if (it.hasNext()) {
                    ...
                    if (yfVar.f138141b.equals(w.mo56107c())) {
    ...
    /* renamed from: w */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final com.google.common.base.C58833ax mo19592w() {
        /*
            r8 = this;
            com.google.android.libraries.assistant.assistantactions.c.b.a.ai r0 = r8.f36384b
            com.google.common.base.ax r0 = r0.f36353d
        ...
        L_0x001f:
            com.google.protobuf.cq r0 = r0.f166812c
            j$.util.stream.Stream r0 = p3186j$.util.Collection.EL.stream(r0)
            com.google.android.libraries.assistant.assistantactions.c.b.a.ap r1 = com.google.android.libraries.assistant.assistantactions.p621c.p623b.p624a.C11080ap.f36359a
            j$.util.stream.Stream r0 = r0.filter(r1)
            j$.util.Optional r0 = r0.findFirst()
            boolean r1 = r0.isPresent()
            if (r1 != 0) goto L_0x0038
        ...
        L_0x00f3:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.assistant.assistantactions.p621c.p623b.p624a.C11101bj.mo19592w():com.google.common.base.ax");
    }

    /* renamed from: x */
    public final /* synthetic */ C58833ax mo19593x() {
        return C11077am.m26203j(this);
    }

    /* renamed from: y */
    public final C58833ax mo19594y() {
        return mo19588s();
    }

    /* renamed from: z */
    public final /* synthetic */ C58833ax mo19595z() {
        return C11077am.m26204k(this);
    }
}
