...
/* renamed from: com.google.android.libraries.assistant.assistantactions.e.g */
/* compiled from: PG */
public final class C11277g {
    /* renamed from: a */
    public static C45634an m26766a(C52625yr yrVar) {
    ...
    /* renamed from: b */
    public static C52623yp m26767b(C45632al alVar) {
        ...
        Collection.EL.stream(alVar.f120026d).forEach(new C11272b(yoVar));
        Collection.EL.stream(alVar.f120029g).forEach(new C11273c(yoVar));
        return (C52623yp) yoVar.build();
    }

    /* renamed from: c */
    public static C52625yr m26768c(C45634an anVar) {
    ...
    /* renamed from: d */
    public static adm m26769d(C56364n nVar) {
    ...
    /* renamed from: e */
    public static C63565b m26770e(ade ade) {
        ...
        if (ade.f134885g.size() != 0) {
            aVar.mo59217b((Iterable) Collection.EL.stream(ade.f134885g).map(C11276f.f36697a).collect(Collectors.toList()));
        }
