...
/* renamed from: com.google.android.libraries.elements.d.f.j */
/* compiled from: PG */
public final /* synthetic */ class C21102j implements Callable {

    /* renamed from: a */
    public final /* synthetic */ C68098t f59139a;

    /* renamed from: b */
    public final /* synthetic */ C21232ab f59140b;

    /* renamed from: c */
    public final /* synthetic */ C70120l f59141c;

    public /* synthetic */ C21102j(C68098t tVar, C21232ab abVar, C70120l lVar) {
        this.f59139a = tVar;
        this.f59140b = abVar;
        this.f59141c = lVar;
    }
    ...
    public final Object call() {
        C68098t tVar = this.f59139a;
        C21232ab abVar = this.f59140b;
        C70120l lVar = this.f59141c;
        ...
        if (avVar == null || adVar == null || avVar.mo60140h() == adVar.mo60104h()) {
            ...
            C58528ij<String> w = f.keySet();
            ArrayList arrayList = new ArrayList(w.size());
            for (String str : w) {
                C21103k kVar = new C21103k(str);
                if ("/environment".equals(str)) {
                    arrayList.add(lVar.mo61652l(C21104l.f59143a).mo61652l(kVar));
                } else {
                    arrayList.add(abVar.mo26139b(str).mo61652l(kVar));
                }
            }
            return C70120l.m102046e(arrayList, C21108p.f59149a, C70092f.f186825a).mo61652l(new C21107o(i, f, a));
        }
