...
/* renamed from: com.google.android.libraries.elements.d.e.au */
/* compiled from: PG */
public final /* synthetic */ class C21015au implements C21343d {

    /* renamed from: a */
    public final /* synthetic */ C6405o f58906a;

    public /* synthetic */ C21015au(C6405o oVar) {
        this.f58906a = oVar;
    }

    /* renamed from: a */
    public final void mo26055a(int i, DimensionProxy dimensionProxy) {
        C6405o oVar = this.f58906a;
        ...
        if (dimensionProxy.unit().ordinal() != 2) {
            oVar.mo13432P(i, oVar.f18979b.mo13257a(dimensionProxy.value()));
            return;
        }
        float value = dimensionProxy.value() * 100.0f;
        C6397j jVar = (C6397j) oVar.f18980c.mo13456J().mo13410D();
        jVar.f18928a |= 67108864;
        if (jVar.f18950w == null) {
            jVar.f18950w = new C6139bt();
        }
        jVar.f18950w.mo13122e(i, value);
        oVar.mo13268k();
    }
}
