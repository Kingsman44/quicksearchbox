...
/* renamed from: com.google.android.libraries.elements.d.e.av */
/* compiled from: PG */
public final /* synthetic */ class C21016av implements C21343d {

    /* renamed from: a */
    public final /* synthetic */ C6405o f58907a;

    public /* synthetic */ C21016av(C6405o oVar) {
        this.f58907a = oVar;
    }

    /* renamed from: a */
    public final void mo26055a(int i, DimensionProxy dimensionProxy) {
        C6405o oVar = this.f58907a;
        ...
        if (dimensionProxy.unit().ordinal() != 2) {
            oVar.mo13434R(i, oVar.f18979b.mo13257a(dimensionProxy.value()));
            return;
        }
        float value = dimensionProxy.value() * 100.0f;
        C6397j jVar = (C6397j) oVar.f18980c.mo13456J().mo13410D();
        jVar.f18928a |= 4194304;
        if (jVar.f18953z == null) {
            jVar.f18953z = new C6139bt();
        }
        jVar.f18953z.mo13122e(i, value);
        oVar.mo13268k();
    }
}
