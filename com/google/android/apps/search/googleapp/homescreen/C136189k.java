...
/* renamed from: com.google.android.apps.search.googleapp.homescreen.k */
/* compiled from: PG */
public final class C136189k implements C46792di {

    /* renamed from: a */
    final /* synthetic */ C136193o f370882a;

    public C136189k(C136193o oVar) {
        this.f370882a = oVar;
    }
    ...
    public final void mo18077a(Throwable th) {
        ...
        cVar.mo56379ah(new C59094n(40692));
        cVar.mo56386p("Error while subscribing to promo manager tooltip data service");
    }

    /* renamed from: b */
    public final /* bridge */ /* synthetic */ void mo18078b(Object obj) {
        View r = C2043bi.m5589r(this.f370882a.f370907b.requireView(), R.id.googleapp_facade_search_box_view);
        C69664n.m101060f(r, "requireViewById<Searchbo…ch_box_view\n            )");
        C137087ap apVar = this.f370882a.f370889B;
        C63934bu buVar = C63934bu.LENS_ICON;
        View a = ((SearchboxView) r).mo17754z().mo112832a();
        apVar.mo113504b(buVar.f172907h, a, (C137007dh) obj);
    }
