...
/* renamed from: com.google.android.apps.search.googleapp.discover.y.j */
/* compiled from: PG */
public final class C135259j extends C135244be {

    /* renamed from: a */
    private final int f368483a;

    /* renamed from: b */
    private final Instant f368484b;

    /* renamed from: c */
    private final C135050dx f368485c;

    public C135259j(int i, Instant instant, C135050dx dxVar) {
        C69664n.m101061g(instant, "fragmentCreationTime");
        C69664n.m101061g(dxVar, "requestConfig");
        this.f368483a = i;
        this.f368484b = instant;
        this.f368485c = dxVar;
    }
    ...
    public final C134286f mo111669a() {
        ...
        C134297q.m217877a("Size", this.f368483a, pVar, arrayList);
        C134297q.m217878b("Fragment creation time", this.f368484b, pVar, arrayList);
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C135259j)) {
            return false;
        }
        C135259j jVar = (C135259j) obj;
        return this.f368483a == jVar.f368483a && C69664n.m101066l(this.f368484b, jVar.f368484b) && C69664n.m101066l(this.f368485c, jVar.f368485c);
    }

    public final int hashCode() {
        return (((this.f368483a * 31) + this.f368484b.hashCode()) * 31) + this.f368485c.hashCode();
    }

    public final String toString() {
        int i = this.f368483a;
        Instant instant = this.f368484b;
        C135050dx dxVar = this.f368485c;
        return "FirstRangeRequest(size=" + i + ", fragmentCreationTime=" + instant + ", requestConfig=" + dxVar + ")";
    }
}
