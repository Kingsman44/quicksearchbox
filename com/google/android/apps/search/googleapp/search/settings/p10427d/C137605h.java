...
/* renamed from: com.google.android.apps.search.googleapp.search.settings.d.h */
/* compiled from: PG */
public final class C137605h implements C139875k {

    /* renamed from: a */
    private final Context f374291a;

    public C137605h(Context context) {
        C69664n.m101061g(context, "context");
        this.f374291a = context;
    }
    ...
    public final Fragment mo111860c(AccountId accountId) {
        ...
        Map map = C137609l.f374297a;
        C137607j jVar = new C137607j();
    ...
    public final String mo111460j() {
        String string = this.f374291a.getString(R.string.googleapp_language_setting_title);
        C69664n.m101060f(string, "context.getString(R.stri…p_language_setting_title)");
        return string;
    }
