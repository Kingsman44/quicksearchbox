...
/* renamed from: com.google.android.apps.search.googleapp.x.a.a */
/* compiled from: PG */
public final class C139859a implements C139858a {

    /* renamed from: a */
    private final Fragment f380161a;

    /* renamed from: b */
    private final C139795f f380162b;

    public C139859a(Fragment fragment, C139795f fVar) {
        C69664n.m101061g(fragment, "fragment");
        this.f380161a = fragment;
        this.f380162b = fVar;
    }
    ...
    public final String mo111460j() {
        String string = this.f380161a.getString(R.string.googleapp_settings_legal_notices_title);
        C69664n.m101060f(string, "fragment.getString(R.str…ings_legal_notices_title)");
        return string;
    }
    ...
    public final C60870cx mo111855o() {
        C139795f fVar = this.f380162b;
        Uri parse = Uri.parse("https://m.google.com/legalnotices");
