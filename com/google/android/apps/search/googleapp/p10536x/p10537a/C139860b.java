...
/* renamed from: com.google.android.apps.search.googleapp.x.a.b */
/* compiled from: PG */
public final class C139860b implements C139858a {

    /* renamed from: a */
    private final Fragment f380163a;

    /* renamed from: b */
    private final C139795f f380164b;

    public C139860b(Fragment fragment, C139795f fVar) {
        C69664n.m101061g(fragment, "fragment");
        this.f380163a = fragment;
        this.f380164b = fVar;
    }
    ...
    public final String mo111460j() {
        String string = this.f380163a.getString(R.string.googleapp_settings_location_terms_of_service_title);
        C69664n.m101060f(string, "fragment.getString(R.str…n_terms_of_service_title)");
        return string;
    }

    /* renamed from: l */
    public final boolean mo111462l() {
        return C69664n.m101066l(Locale.getDefault().getCountry(), "KR");
    }
    ...
    public final C60870cx mo111855o() {
        C139795f fVar = this.f380164b;
        Uri parse = Uri.parse("https://www.google.co.kr/policies/terms/location");
