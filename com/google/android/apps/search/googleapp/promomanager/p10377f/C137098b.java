...
/* renamed from: com.google.android.apps.search.googleapp.promomanager.f.b */
/* compiled from: PG */
public final class C137098b extends C137131y implements C47231d, C68288b, C47200b, C47233b, C47570bu {

    /* renamed from: a */
    private C137110d f373070a;

    /* renamed from: c */
    private Context f373071c;

    /* renamed from: d */
    private final C2393x f373072d = new C2393x(this);

    /* renamed from: e */
    private final C47515ab f373073e = new C47515ab(this);

    /* renamed from: f */
    private boolean f373074f;

    /* renamed from: g */
    private boolean f373075g;
    ...
    /* renamed from: a */
    static C137098b m222794a(AccountId accountId, C137007dh dhVar) {
        C137098b bVar = new C137098b();
        C68324h.m98669f(bVar);
        C47247a.m84047b(bVar, accountId);
        C47243l.m84039a(bVar, dhVar);
        return bVar;
    }

    /* renamed from: b */
    public final C137110d mo17754z() {
        C137110d dVar = this.f373070a;
        if (dVar == null) {
            throw new IllegalStateException("peer() called before initialized.");
        } else if (!this.f373075g) {
            return dVar;
        } else {
    ...
    /* renamed from: d */
    public final /* synthetic */ C47222f mo113518d() {
    ...
    public final Context mo17857e() {
        if (this.f373071c == null) {
            this.f373071c = new C47236e((Fragment) this, super.getContext());
        }
        return this.f373071c;
    }

    /* renamed from: g */
    public final C47816ey mo17859g() {
        return this.f373073e.f123354b;
    }
    ...
    public final void mo17861i(C47816ey eyVar, boolean z) {
        this.f373073e.mo51380h(eyVar, z);
    }

    public final void onActivityCreated(Bundle bundle) {
        this.f373073e.mo51381i();
        try {
    ...
    public final void onActivityResult(int i, int i2, Intent intent) {
        C47573bx a = this.f373073e.mo51373a("Fragment:onActivityResult");
        try {
    ...
    public final void onCancel(DialogInterface dialogInterface) {
        this.f373073e.mo51378f("DialogFragment:onCancel").close();
    }
    ...
    public final android.app.Dialog onCreateDialog(android.os.Bundle r15) {
        /*
            ...
            com.google.android.apps.search.googleapp.promomanager.f.d r15 = r14.mo17754z()
            com.google.android.apps.search.googleapp.urlhandler.k r0 = r15.f373106f
            com.google.android.apps.search.googleapp.promomanager.f.c r1 = new com.google.android.apps.search.googleapp.promomanager.f.c
            r1.<init>(r15)
            r0.mo115295d(r1)
            android.app.Dialog r0 = new android.app.Dialog
            android.content.Context r1 = r15.f373102b
            r0.<init>(r1)
            android.content.Context r1 = r15.f373102b
            ...
            com.google.android.apps.search.googleapp.promomanager.b.dh r2 = r15.f373104d
            int r4 = r2.f372872b
            int r5 = com.google.android.apps.search.googleapp.promomanager.p10372b.C137006dg.m222698a(r4)
            int r6 = r5 + -1
            if (r5 == 0) goto L_0x020e
            r3 = 2131431466(0x7f0b102a, float:1.8484662E38)
            r5 = 2131431465(0x7f0b1029, float:1.848466E38)
            r7 = 2131431467(0x7f0b102b, float:1.8484664E38)
            r8 = 1
            r9 = 2131431463(0x7f0b1027, float:1.8484656E38)
            r10 = 2131431464(0x7f0b1028, float:1.8484658E38)
            r11 = 8
            ...
            goto L_0x01fa
        L_0x0051:
            com.google.common.f.e r15 = com.google.android.apps.search.googleapp.promomanager.p10377f.C137110d.f373101a
        ...
        L_0x00c8:
            ...
            com.google.protos.aw.a.a.a.y r5 = r2.f172800f
        ...
        L_0x0117:
            ...
            goto L_0x01fa
        L_0x012b:
            android.view.View r15 = r1.findViewById(r9)
            r15.setVisibility(r11)
            goto L_0x01fa
        L_0x0134:
            android.content.Context r6 = r15.f373102b
            com.google.apps.tiktok.media.e r15 = r15.f373105e
        ...
        L_0x0178:
            android.view.View r4 = r1.findViewById(r5)
            android.widget.Button r4 = (android.widget.Button) r4
            com.google.protos.aq.g r5 = r2.f172496h
        ...
        L_0x020e:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.apps.search.googleapp.promomanager.p10377f.C137098b.onCreateDialog(android.os.Bundle):android.app.Dialog");
    }
    ...
    public final void onDestroy() {
        C47573bx b = this.f373073e.mo51374b();
        try {
            super.onDestroy();
            b.close();
            return;
    ...
    public final void onDestroyView() {
        C47573bx c = this.f373073e.mo51375c();
        try {
            super.onDestroyView();
            c.close();
            return;
    ...
    public final void onDetach() {
        C47573bx d = this.f373073e.mo51376d();
        try {
            super.onDetach();
            this.f373075g = true;
            d.close();
    ...
    public final void onDismiss(DialogInterface dialogInterface) {
        C47573bx f = this.f373073e.mo51378f("DialogFragment:onDismiss");
        try {
            super.onDismiss(dialogInterface);
            C137110d b = mo17754z();
            if (b.f373108h) {
                b.f373103c.mo113457n(b.f373104d);
            }
            f.close();
            return;
        } catch (Throwable th) {
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        C47573bx a = this.f373073e.mo51373a("Fragment:onOptionsItemSelected");
        try {
    ...
    public final void onResume() {
        C47573bx e = this.f373073e.mo51377e();
        try {
            super.onResume();
            e.close();
            return;
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        this.f373073e.mo51381i();
        try {
            if (!getShowsDialog() && !this.f373074f) {
                C47400m a = C47389c.m84226a(getContext());
                a.f123128b = view;
                C137113g.m222819a(a, mo17754z());
                this.f373074f = true;
            }
    ...
    public final void onAttach(Context context) {
        ...
        try {
            if (!this.f373075g) {
                ...
                if (this.f373070a == null) {
                    this.f373070a = ((C137114h) mo113547f().mo17653jN()).mo113534cW();
                    super.getLifecycle().mo5790b(new TracedFragmentLifecycle(this.f373073e, this.f373072d));
                }
