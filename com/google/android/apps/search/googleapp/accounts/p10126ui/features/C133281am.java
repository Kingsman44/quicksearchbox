...
import com.google.android.apps.gsa.h.n.a;
...
/* renamed from: com.google.android.apps.search.googleapp.accounts.ui.features.am */
/* compiled from: PG */
public final class C133281am implements C68220f {
    /* renamed from: a */
    public static C30631n m216320a(Fragment fragment, a aVar, C30306o oVar, C47770dh dhVar, C133255c cVar) {
        C30630m k = C30631n.m57247k();
        k.mo36303d(fragment.getResources().getString(R.string.googleapp_accountmenu_reminders));
        Drawable a = C1877c.m5125a(fragment.requireContext(), R.drawable.quantum_ic_reminders_alt_white_24);
        a.getClass();
        C30606g gVar = (C30606g) k;
        gVar.f82676a = a;
        gVar.f82677b = new C47591co(dhVar, "Google App Account Menu Reminders clicked", new C133299f(cVar, aVar));
        gVar.f82678c = new C30478s(oVar);
        k.mo36304e(139628);
