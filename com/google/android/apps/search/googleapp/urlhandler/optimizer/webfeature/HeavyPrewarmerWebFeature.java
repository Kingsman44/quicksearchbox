package com.google.android.apps.search.googleapp.urlhandler.optimizer.webfeature;
...
/* compiled from: PG */
public abstract class HeavyPrewarmerWebFeature implements WebFeature {
    /* renamed from: a */
    public final WebFeatureConfig mo41576a() {
        C44085c cVar = new C44085c();
        cVar.f114767d.add(HeavyPrewarmerWebFeatureSetup.class);
    ...
    public final Class mo41578c() {
        return HeavyPrewarmerWebFeature.class;
    }
}
