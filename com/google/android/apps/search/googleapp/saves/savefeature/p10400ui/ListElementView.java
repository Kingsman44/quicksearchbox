...
/* renamed from: com.google.android.apps.search.googleapp.saves.savefeature.ui.ListElementView */
/* compiled from: PG */
public final class ListElementView extends C137341ay implements C47231d {

    /* renamed from: a */
    private C137366o f373515a;
    ...
    /* renamed from: e */
    private final void m223066e() {
        if (this.f373515a == null) {
            try {
                this.f373515a = ((C137367p) mo113665b().mo17653jN()).mo113691n();
    ...
    /* renamed from: a */
    public final C137366o mo17754z() {
        C137366o oVar = this.f373515a;
        if (oVar != null) {
            return oVar;
        }
    ...
    public ListElementView(C47274n nVar) {
        super(nVar);
        m223066e();
    }
}
