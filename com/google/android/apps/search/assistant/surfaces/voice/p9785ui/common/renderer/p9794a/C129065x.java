...
/* renamed from: com.google.android.apps.search.assistant.surfaces.voice.ui.common.renderer.a.x */
/* compiled from: PG */
public final /* synthetic */ class C129065x implements C69822d {

    /* renamed from: a */
    public final /* synthetic */ C129037ak f354553a;

    /* renamed from: b */
    public final /* synthetic */ C57741e f354554b;

    /* renamed from: c */
    public final /* synthetic */ MediaMetadata f354555c;

    /* renamed from: d */
    public final /* synthetic */ MediaController f354556d;

    public /* synthetic */ C129065x(C129037ak akVar, C57741e eVar, MediaMetadata mediaMetadata, MediaController mediaController) {
        this.f354553a = akVar;
        this.f354554b = eVar;
        this.f354555c = mediaMetadata;
        this.f354556d = mediaController;
    }

    /* renamed from: a */
    public final Object mo25875a(Object obj) {
        C129037ak akVar = this.f354553a;
        C57741e eVar = this.f354554b;
        MediaMetadata mediaMetadata = this.f354555c;
        MediaController mediaController = this.f354556d;
        C57741e eVar2 = (C57741e) obj;
        if (mediaMetadata == null) {
            ((C59052c) ((C59052c) C129037ak.f354499a.mo56224b()).mo56372aa(38108)).mo56386p("#MediaStateObserverImpl, updateMediaDetails failed, reason: MediaMetadata is null.");
            return eVar2;
        }
        C57740d dVar = (C57740d) eVar2.toBuilder();
        String string = mediaMetadata.getString("android.media.metadata.TITLE");
        if (C58837ba.m90859h(string)) {
            string = akVar.f354500b.getString(R.string.assistant_eml_card_unknown_media_info);
        }
        String string2 = mediaMetadata.getString("android.media.metadata.ARTIST");
        if (C58837ba.m90859h(string2)) {
            string2 = akVar.f354500b.getString(R.string.assistant_eml_card_unknown_media_info);
        }
        if (dVar != null) {
            ...
            if (!C58837ba.m90859h(string3)) {
                ...
                if (cyVar3.f179958a.size() > 0) {
                    ...
                    if (((C66187da) cyVar4.f179958a.get(0)).f179980b == 1) {
                        ...
                        cyVar6.getClass();
                        eVar8.f154263e = cyVar6;
                        eVar8.f154259a |= 16;
                    }
                }
                if ((eVar.f154259a & 64) != 0) {
        ...
        if (mediaController != null) {
            ...
            try {
                Drawable applicationIcon = akVar.f354500b.getPackageManager().getApplicationIcon(packageName);
                if (applicationIcon == null) {
                    ((C59052c) ((C59052c) C129037ak.f354499a.mo56224b()).mo56372aa(38106)).mo56386p("#MediaStateObserverImpl, getCurrentMediaApplicationIcon failed, reason: Media icon drawable was not found.");
                } else {
                    Bitmap createBitmap = Bitmap.createBitmap(applicationIcon.getIntrinsicWidth(), applicationIcon.getIntrinsicHeight(), Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(createBitmap);
                    applicationIcon.setBounds(0, 0, canvas.getWidth(), canvas.getHeight());
                    applicationIcon.draw(canvas);
                    zVar = C129037ak.m210623c(createBitmap);
                }
            } catch (PackageManager.NameNotFoundException e) {
                ((C59052c) ((C59052c) ((C59052c) C129037ak.f354499a.mo56225c()).mo56382g(e)).mo56372aa(38107)).mo56389s("#MediaStateObserverImpl, getCurrentMediaApplicationIcon failed, reason: media provider name not found %s", packageName);
            }
        }
        if (zVar != null) {
        ...
        string.getClass();
        eVar11.f154259a |= 1;
        eVar11.f154260b = string;
        dVar.copyOnWrite();
        C57741e eVar12 = (C57741e) dVar.instance;
        string2.getClass();
        eVar12.f154259a |= 2;
        eVar12.f154261c = string2;
