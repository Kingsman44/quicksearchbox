...
/* renamed from: com.google.android.apps.search.assistant.surfaces.voice.ui.interpreter.micplate.k */
/* compiled from: PG */
final class C130015k implements View.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ C130019o f356539a;

    public C130015k(C130019o oVar) {
        this.f356539a = oVar;
    }

    public final void onClick(View view) {
        C130019o oVar = this.f356539a;
        oVar.f356550h.mo108811c(oVar.mo109414f());
        C59052c cVar = (C59052c) C130019o.f356543a.mo56224b();
        cVar.mo56379ah(new C59094n(38607));
        cVar.mo56386p("On targetKeyboardMicButton Click");
        C130019o oVar2 = this.f356539a;
        ...
        anVar2.copyOnWrite();
        ((C129906ao) anVar2.instance).f356353a = false;
