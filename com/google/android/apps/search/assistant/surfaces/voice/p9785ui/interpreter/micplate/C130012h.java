...
/* renamed from: com.google.android.apps.search.assistant.surfaces.voice.ui.interpreter.micplate.h */
/* compiled from: PG */
final class C130012h implements View.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ C130019o f356536a;

    public C130012h(C130019o oVar) {
        this.f356536a = oVar;
    }

    public final void onClick(View view) {
        C130019o oVar = this.f356536a;
        oVar.f356550h.mo108811c(oVar.mo109416h());
        C59052c cVar = (C59052c) C130019o.f356543a.mo56224b();
        cVar.mo56379ah(new C59094n(38604));
        cVar.mo56386p("On sourceManualMicButton Click");
        C130019o oVar2 = this.f356536a;
        ...
        ayVar2.copyOnWrite();
        ((C129917az) ayVar2.instance).f356364a = true;
        a2.mo109344b(a3.mo109345a());
        a.mo109350c(a2.mo109343a());
        this.f356536a.mo109418j(a.mo109348a());
    }
}
