...
/* renamed from: com.google.android.apps.search.assistant.surfaces.dictation.service.fulfillment.a.b.a.br */
/* compiled from: PG */
public final class C125579br {
    /* renamed from: a */
    public static final C125693z m205580a(String str, C69762k kVar) {
        String str2;
        String str3;
        C69759h c = kVar.mo61435c(str);
        List a = c != null ? c.mo61432a() : null;
        C125666as asVar = (a == null || (str3 = (String) a.get(1)) == null) ? null : (C125666as) C125586by.f346220h.get(str3);
