...
/* renamed from: com.google.android.apps.search.assistant.surfaces.dictation.service.fulfillment.a.b.a.dc */
/* compiled from: PG */
public final class C125618dc {
    /* renamed from: a */
    public static final C125693z m205619a(String str, C69762k kVar) {
        String str2;
        String str3;
        C69759h c = kVar.mo61435c(str);
        List a = c != null ? c.mo61432a() : null;
        C125666as asVar = (a == null || (str3 = (String) a.get(1)) == null) ? null : (C125666as) C125625dj.f346273h.get(str3);
