...
/* renamed from: com.google.android.apps.search.assistant.verticals.ambient.o.a.d */
/* compiled from: PG */
public final /* synthetic */ class C131105d implements C131713d {

    /* renamed from: a */
    public final /* synthetic */ C131114m f358583a;

    public /* synthetic */ C131105d(C131114m mVar) {
        this.f358583a = mVar;
    }

    /* renamed from: a */
    public final C60870cx mo110075a(C131701c cVar) {
        C131114m mVar = this.f358583a;
        C53713bk bkVar = (C53713bk) C53715bm.f141021c.createBuilder();
        C131687a aVar = (C131687a) cVar;
        bkVar.copyOnWrite();
        C53715bm bmVar = (C53715bm) bkVar.instance;
        bmVar.f141024b = (C106588b) aVar.f359794a;
        bmVar.f141023a = 12;
        return mVar.mo110074b((C53715bm) bkVar.build(), aVar.f359795b);
    }
}
