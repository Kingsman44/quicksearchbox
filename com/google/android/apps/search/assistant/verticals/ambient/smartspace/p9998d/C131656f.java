...
/* renamed from: com.google.android.apps.search.assistant.verticals.ambient.smartspace.d.f */
/* compiled from: PG */
public final class C131656f {

    /* renamed from: a */
    private static final C59071e f359730a = C59071e.m91332i("com.google.android.apps.search.assistant.verticals.ambient.smartspace.d.f");

    static {
        C58528ij.m90011K(C64431v.CANCELED_CASE, C64431v.UNKNOWN_CASE);
    }

    /* renamed from: a */
    public static C58485gu m214099a(C57017i iVar) {
        Optional optional;
        C57017i iVar2 = iVar;
        ...
        if (i == 19) {
            ...
            if ((tVar.f174761a & 8192) != 0) {
                ...
                try {
                    ...
                    if (i3 == 8) {
                        C53182ek d2 = m214102d((C64422m) nVar.f174744c);
                        eiVar.copyOnWrite();
                        ...
                        C53182ek d3 = m214102d((C64422m) nVar.f174744c);
                        eiVar.copyOnWrite();
                    ...
                    if (i4 == 11) {
                        C53182ek d5 = m214102d((C64422m) nVar.f174746e);
                        eiVar.copyOnWrite();
                        ...
                        C53182ek d6 = m214102d((C64422m) nVar.f174746e);
                        eiVar.copyOnWrite();
                    ...
                    C59104x d7 = f359730a.mo56226d();
                    d7.mo56378ag(C58975e.f156826a, "FlightUtils");
                    ((C59052c) ((C59052c) ((C59052c) d7).mo56382g(e3)).mo56372aa(39151)).mo56389s("Flight number does not contain valid numeric part %s", hVar.f174728b);
                    optional = Optional.empty();
                }
            } else {
                optional = Optional.empty();
            }
            return m214104f(optional);
        } else if (i != 1) {
            ...
            try {
                ...
                C59104x d8 = f359730a.mo56226d();
                d8.mo56378ag(C58975e.f156826a, "FlightUtils");
                ((C59052c) ((C59052c) ((C59052c) d8).mo56382g(e4)).mo56372aa(39150)).mo56389s("Flight number does not contain valid numeric part %s", lVar.f174693d);
            }
            ...
            return m214104f(Optional.m71637of((C53190es) eiVar2.build()));
        }
    }

    /* renamed from: b */
    public static Optional m214100b(String str) {
        try {
            return Optional.m71637of(Long.valueOf(OffsetDateTime.parse(str).toInstant().toEpochMilli()));
        } catch (DateTimeParseException e) {
            C59104x d = f359730a.mo56226d();
            d.mo56378ag(C58975e.f156826a, "FlightUtils");
            ((C59052c) ((C59052c) ((C59052c) d).mo56382g(e)).mo56372aa(39152)).mo56389s("Unable to parse flight time %s using OffsetDateTime", str);
            return Optional.empty();
        }
    }

    /* renamed from: c */
    public static String m214101c(C53190es esVar) {
        C53187ep epVar = esVar.f139401f;
        if (epVar == null) {
            epVar = C53187ep.f139383h;
        }
        String str = epVar.f139386b;
        C53187ep epVar2 = esVar.f139402g;
        if (epVar2 == null) {
            epVar2 = C53187ep.f139383h;
        }
        String str2 = epVar2.f139386b;
        C53179eh ehVar = esVar.f139405j;
        if (ehVar == null) {
            ehVar = C53179eh.f139366e;
        }
        String str3 = ehVar.f139370c;
        int i = esVar.f139406k;
        return str + str2 + str3 + i;
    }

    /* renamed from: d */
    private static C53182ek m214102d(C64422m mVar) {
        C53182ek ekVar = (C53182ek) C53183el.f139373c.createBuilder();
    ...
    /* renamed from: e */
    private static C53186eo m214103e(C64419j jVar) {
        C53186eo eoVar = (C53186eo) C53187ep.f139383h.createBuilder();
    ...
    /* renamed from: f */
    private static C58485gu m214104f(Optional optional) {
