...
/* renamed from: com.google.android.apps.search.assistant.verticals.ambient.smartspace.h.c */
/* compiled from: PG */
public final /* synthetic */ class C131670c implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ C123714ah f359759a;

    /* renamed from: b */
    public final /* synthetic */ C50790cn f359760b;

    public /* synthetic */ C131670c(C123714ah ahVar, C50790cn cnVar) {
        this.f359759a = ahVar;
        this.f359760b = cnVar;
    }

    public final Object apply(Object obj) {
        C123714ah ahVar = this.f359759a;
        C50790cn cnVar = this.f359760b;
        C63088z zVar = (C63088z) obj;
        Intent intent = new Intent("android.intent.action.VIEW");
        intent.setData(Uri.parse(ahVar.f341722e));
