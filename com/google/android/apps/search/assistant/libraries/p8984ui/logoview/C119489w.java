...
/* renamed from: com.google.android.apps.search.assistant.libraries.ui.logoview.w */
/* compiled from: PG */
final class C119489w extends C119456al {
    public C119489w() {
    ...
    public final boolean mo104365c(long j, long j2, C119463b bVar) {
        bVar.mo104384c(0.0f);
        if (!C119457am.m198244l(bVar) || j2 - j >= 100) {
            C119457am.m198243k(bVar);
            Iterator it = bVar.iterator();
            while (it.hasNext()) {
                if (((C119462a) it.next()).f333040j.f332975c > 0.001f) {
                    return true;
                }
            }
            return false;
        }
        C119457am.m198235c(bVar);
        return true;
    }
}
