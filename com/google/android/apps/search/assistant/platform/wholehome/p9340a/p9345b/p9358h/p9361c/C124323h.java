...
import com.google.assistant.p3741aa.p3742a.p3743a.p3744a.C48146o;
import com.google.assistant.p3741aa.p3742a.p3743a.p3744a.C48147p;
...
/* renamed from: com.google.android.apps.search.assistant.platform.wholehome.a.b.h.c.h */
/* compiled from: PG */
final class C124323h extends C48147p {

    /* renamed from: g */
    private static final C59071e f343194g = C59071e.m91332i("com.google.android.apps.search.assistant.platform.wholehome.a.b.h.c.h");

    /* renamed from: h */
    private final C124271b f343195h;

    public C124323h(C124271b bVar) {
        this.f343195h = bVar;
    }

    /* renamed from: a */
    public final void mo106375a() {
        ((C59052c) ((C59052c) f343194g.mo56224b()).mo56372aa(36170)).mo56386p("Receives onPublisherNotReachable on CrossDeviceTrait.");
        this.f343195h.mo106355a(this.f395018c.f394833c);
    }

    /* renamed from: b */
    public final /* synthetic */ void mo106376b() {
        ((C59052c) ((C59052c) f343194g.mo56224b()).mo56372aa(36169)).mo56386p("Receives new CrossDevice trait.");
        ...
        C51527l lVar = ((C48146o) this.f395021e).f124582b;
        if (lVar == null) {
        ...
        bVar.f124597b = lVar;
        bVar.f124596a |= 1;
        C51594nm nmVar = ((C48146o) this.f395021e).f124581a;
        if (nmVar == null) {
        ...
        nVar3.f124624a |= 4;
        this.f343195h.mo106356b((C48166n) kVar.build(), true);
    }
}
