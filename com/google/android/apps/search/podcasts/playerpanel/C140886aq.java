...
/* renamed from: com.google.android.apps.search.podcasts.playerpanel.aq */
/* compiled from: PG */
final class C140886aq implements View.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ C140912ba f382574a;

    public C140886aq(C140912ba baVar) {
        this.f382574a = baVar;
    }

    public final void onClick(View view) {
        C140641b bVar = this.f382574a.f382623a.f380978a;
        if (bVar == null) {
