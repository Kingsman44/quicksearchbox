...
/* renamed from: com.google.android.apps.search.podcasts.playerpanel.ar */
/* compiled from: PG */
final class C140887ar implements View.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ C140912ba f382575a;

    public C140887ar(C140912ba baVar) {
        this.f382575a = baVar;
    }

    public final void onClick(View view) {
        C140641b bVar = this.f382575a.f382623a.f380978a;
        if (bVar == null) {
