...
/* renamed from: com.google.android.apps.search.podcasts.playerpanel.az */
/* compiled from: PG */
final class C140895az implements View.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ C140912ba f382583a;

    public C140895az(C140912ba baVar) {
        this.f382583a = baVar;
    }

    public final void onClick(View view) {
        C140641b bVar = this.f382583a.f382623a.f380978a;
        if (bVar == null) {
