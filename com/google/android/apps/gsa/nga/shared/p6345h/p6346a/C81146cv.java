...
/* renamed from: com.google.android.apps.gsa.nga.shared.h.a.cv */
/* compiled from: PG */
public final /* synthetic */ class C81146cv implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ C58833ax f222267a;

    public /* synthetic */ C81146cv(C58833ax axVar) {
        this.f222267a = axVar;
    }

    public final Object apply(Object obj) {
        C81241af afVar = (C81241af) obj;
        String str = (String) this.f222267a.mo56109e(BuildConfig.FLAVOR);
        ...
        str.getClass();
        Map unmodifiableMap = Collections.unmodifiableMap(((C81270ba) arVar.instance).f222466b);
        ...
        C62995dn dnVar = baVar2.f222466b;
        if (!dnVar.f170058b) {
            baVar2.f222466b = dnVar.mo58980a();
        }
        baVar2.f222466b.put(str, Integer.valueOf(i));
