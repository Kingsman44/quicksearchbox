...
/* renamed from: com.google.android.apps.gsa.nga.shared.h.a.ct */
/* compiled from: PG */
public final /* synthetic */ class C81144ct implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ C58833ax f222265a;

    public /* synthetic */ C81144ct(C58833ax axVar) {
        this.f222265a = axVar;
    }

    public final Object apply(Object obj) {
        C81241af afVar = (C81241af) obj;
        String str = (String) this.f222265a.mo56109e(BuildConfig.FLAVOR);
        ...
        str.getClass();
        Map unmodifiableMap = Collections.unmodifiableMap(((C81270ba) arVar.instance).f222465a);
        ...
        C62995dn dnVar = baVar2.f222465a;
        if (!dnVar.f170058b) {
            baVar2.f222465a = dnVar.mo58980a();
        }
        baVar2.f222465a.put(str, Integer.valueOf(i));
