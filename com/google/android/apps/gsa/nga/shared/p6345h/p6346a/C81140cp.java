...
/* renamed from: com.google.android.apps.gsa.nga.shared.h.a.cp */
/* compiled from: PG */
public final /* synthetic */ class C81140cp implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ C58833ax f222261a;

    public /* synthetic */ C81140cp(C58833ax axVar) {
        this.f222261a = axVar;
    }

    public final Object apply(Object obj) {
        C81241af afVar = (C81241af) obj;
        String str = (String) this.f222261a.mo56109e(BuildConfig.FLAVOR);
        ...
        str.getClass();
        Map unmodifiableMap = Collections.unmodifiableMap(((C81270ba) arVar.instance).f222470f);
        ...
        C62995dn dnVar = baVar2.f222470f;
        if (!dnVar.f170058b) {
            baVar2.f222470f = dnVar.mo58980a();
        }
        baVar2.f222470f.put(str, Integer.valueOf(i));
