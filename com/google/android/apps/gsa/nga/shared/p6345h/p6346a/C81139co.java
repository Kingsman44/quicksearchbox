...
/* renamed from: com.google.android.apps.gsa.nga.shared.h.a.co */
/* compiled from: PG */
public final /* synthetic */ class C81139co implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ C58833ax f222260a;

    public /* synthetic */ C81139co(C58833ax axVar) {
        this.f222260a = axVar;
    }

    public final Object apply(Object obj) {
        C81241af afVar = (C81241af) obj;
        String str = (String) this.f222260a.mo56109e(BuildConfig.FLAVOR);
        ...
        str.getClass();
        Map unmodifiableMap = Collections.unmodifiableMap(((C81270ba) arVar.instance).f222467c);
        ...
        C62995dn dnVar = baVar2.f222467c;
        if (!dnVar.f170058b) {
            baVar2.f222467c = dnVar.mo58980a();
        }
        baVar2.f222467c.put(str, Integer.valueOf(i));
