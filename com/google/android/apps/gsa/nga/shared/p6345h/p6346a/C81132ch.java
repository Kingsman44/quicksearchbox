...
/* renamed from: com.google.android.apps.gsa.nga.shared.h.a.ch */
/* compiled from: PG */
public final /* synthetic */ class C81132ch implements C58817ah {

    /* renamed from: a */
    public final /* synthetic */ C58833ax f222253a;

    public /* synthetic */ C81132ch(C58833ax axVar) {
        this.f222253a = axVar;
    }

    public final Object apply(Object obj) {
        C81241af afVar = (C81241af) obj;
        String str = (String) this.f222253a.mo56109e(BuildConfig.FLAVOR);
        ...
        str.getClass();
        Map unmodifiableMap = Collections.unmodifiableMap(((C81270ba) arVar.instance).f222469e);
        ...
        C62995dn dnVar = baVar2.f222469e;
        if (!dnVar.f170058b) {
            baVar2.f222469e = dnVar.mo58980a();
        }
        baVar2.f222469e.put(str, Integer.valueOf(i));
