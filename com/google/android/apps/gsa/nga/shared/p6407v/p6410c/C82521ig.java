...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ig */
/* compiled from: PG */
public abstract class C82521ig implements C82548jg {
    /* renamed from: c */
    public static C82520if m131317c() {
        C82742t tVar = new C82742t();
        tVar.f225491a = "DID_QUERY_CLASSIFIER_INFERENCE_ERROR_COUNT";
        return tVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "DID_QUERY_CLASSIFIER_INFERENCE_ERROR_COUNT";
    ...
    /* renamed from: b */
    public abstract String mo76561b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227088cm.mo6453a()).mo24822a(1, str, mo76561b());
    }
}
