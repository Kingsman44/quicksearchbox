...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mh */
/* compiled from: PG */
public abstract class C82630mh implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_OPA_HANDOVER_GRAPH_FAILED_ROOT_CAUSE";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "gsa_error_code";
        int b = mo76040b();
        aed.copyOnWrite();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227102d.mo6453a()).mo24822a(1, str, str2, Integer.valueOf(mo76040b()));
    }
}
