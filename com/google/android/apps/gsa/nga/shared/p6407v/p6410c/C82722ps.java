...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ps */
/* compiled from: PG */
public abstract class C82722ps implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "S3_NETWORK_LATENCY";
        double doubleValue = mo76462b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76462b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227117s.mo6453a()).mo24824b(mo76462b().doubleValue(), str, str2);
    }
}
