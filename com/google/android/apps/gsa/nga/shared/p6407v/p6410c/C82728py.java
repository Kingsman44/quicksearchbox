...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.py */
/* compiled from: PG */
public abstract class C82728py implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "TC_LIB_ANNOTATION_REQUEST_LATENCY";
        double doubleValue = mo76488g().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo76484b();

    /* renamed from: c */
    public abstract int mo76485c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ...
        int f = mo76487f();
        int c = mo76485c();
        ((C19569f) ifVar.f226950S.mo6453a()).mo24824b(doubleValue, str, str2, Integer.valueOf(b), Integer.valueOf(f), Integer.valueOf(c), mo76489h());
    }

    /* renamed from: f */
    public abstract int mo76487f();

    /* renamed from: g */
    public abstract Double mo76488g();

    /* renamed from: h */
    public abstract String mo76489h();
}
