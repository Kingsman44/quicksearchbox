...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.qe */
/* compiled from: PG */
public abstract class C82735qe implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "UNINTENDED_QUERY_SUPPRESSION_LATENCY";
        double doubleValue = mo76521b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76521b();

    /* renamed from: c */
    public abstract String mo76522c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227096cu.mo6453a()).mo24824b(mo76521b().doubleValue(), str, mo76522c());
    }
}
