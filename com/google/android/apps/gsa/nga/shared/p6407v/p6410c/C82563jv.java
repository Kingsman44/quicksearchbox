...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.jv */
/* compiled from: PG */
public abstract class C82563jv implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_DASHER_ACCOUNT_PRESENT";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "dasher_account_status";
        String b = mo75759b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo75759b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f226992ah.mo6453a()).mo24822a(1, str, str2, mo75759b());
    }
}
