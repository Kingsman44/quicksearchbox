...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.kj */
/* compiled from: PG */
public abstract class C82578kj implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_FILE_PROVIDER_WRAPPER_LATENCY";
        double doubleValue = mo75808f().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo75805b();

    /* renamed from: c */
    public abstract int mo75806c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227101cz.mo6453a()).mo24824b(mo75808f().doubleValue(), str, str2, Integer.valueOf(mo75805b()), Integer.valueOf(mo75806c()));
    }

    /* renamed from: f */
    public abstract Double mo75808f();
}
