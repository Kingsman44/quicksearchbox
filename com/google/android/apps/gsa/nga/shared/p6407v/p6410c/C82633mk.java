...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mk */
/* compiled from: PG */
public abstract class C82633mk implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_OPA_HANDOVER_VIOLATIONS_DEVICE_TIER";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "violation";
        String c = mo76052c();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo76051b();

    /* renamed from: c */
    public abstract String mo76052c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227103e.mo6453a()).mo24822a(1, str, str2, mo76052c(), mo76051b());
    }
}
