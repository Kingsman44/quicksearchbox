...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ph */
/* compiled from: PG */
public abstract class C82711ph implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "OPA_CLOUD_FULFILLMENT_GRAPH_PRODUCER_LATENCY";
        double doubleValue = mo76415b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76415b();

    /* renamed from: c */
    public abstract String mo76416c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227072cH.mo6453a()).mo24824b(mo76415b().doubleValue(), str, mo76416c(), mo76418f());
    }

    /* renamed from: f */
    public abstract String mo76418f();
}
