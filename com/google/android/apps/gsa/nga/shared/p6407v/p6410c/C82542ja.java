...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ja */
/* compiled from: PG */
public abstract class C82542ja implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "MIC_DURATION2";
        double doubleValue = mo75647b().doubleValue();
        aec.copyOnWrite();
        ...
        aee6.f158450b = 3;
        aee6.f158451c = Boolean.valueOf(mo75650f());
        aec.mo56976a((aee) aed3.build());
        return (aef) aec.build();
    }

    /* renamed from: b */
    public abstract Double mo75647b();

    /* renamed from: c */
    public abstract String mo75648c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        double doubleValue = mo75647b().doubleValue();
        boolean g = mo75651g();
        ((C19569f) ifVar.f227006av.mo6453a()).mo24824b(doubleValue, str, str2, Boolean.valueOf(g), mo75648c(), Boolean.valueOf(mo75650f()));
    }

    /* renamed from: f */
    public abstract boolean mo75650f();

    /* renamed from: g */
    public abstract boolean mo75651g();
}
