...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.on */
/* compiled from: PG */
public abstract class C82690on implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_WARM_ACTIONS_CONTEXT_INELIGIBILITY_REASON";
        ...
        aee3.f158449a |= 1;
        aee3.f158452d = "ineligibility_reason";
        String c = mo76322c();
        aed2.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo76321b();

    /* renamed from: c */
    public abstract String mo76322c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        int b = mo76321b();
        ((C19567d) ifVar.f227034bW.mo6453a()).mo24822a(1, str, str2, Integer.valueOf(b), mo76322c());
    }
}
