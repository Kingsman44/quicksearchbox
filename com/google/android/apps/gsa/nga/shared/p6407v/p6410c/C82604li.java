...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.li */
/* compiled from: PG */
public abstract class C82604li implements C82548jg {
    /* renamed from: g */
    public static C82603lh m131700g() {
        C82373cu cuVar = new C82373cu();
        cuVar.f225038a = "NGA_INITIAL_DOWNLOADER_BUTTON_HEIGHT";
        return cuVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_INITIAL_DOWNLOADER_BUTTON_HEIGHT";
        double doubleValue = mo75916b().doubleValue();
        aec.copyOnWrite();
        ...
        aee3.f158449a |= 1;
        aee3.f158452d = "attempted_bug_fix";
        boolean f = mo75919f();
        aed2.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo75916b();

    /* renamed from: c */
    public abstract String mo75917c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227068cD.mo6453a()).mo24824b(mo75916b().doubleValue(), str, str2, mo75917c(), Boolean.valueOf(mo75919f()));
    }

    /* renamed from: f */
    public abstract boolean mo75919f();
}
