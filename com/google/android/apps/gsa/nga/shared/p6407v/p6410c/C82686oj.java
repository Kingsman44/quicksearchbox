...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.oj */
/* compiled from: PG */
public abstract class C82686oj implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_VIS_SHOW_AFTER_CREATED";
        double doubleValue = mo76301b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76301b();

    /* renamed from: c */
    public abstract String mo76302c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227015bD.mo6453a()).mo24824b(mo76301b().doubleValue(), mo76302c(), mo76304f());
    }

    /* renamed from: f */
    public abstract String mo76304f();
}
