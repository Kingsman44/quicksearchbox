...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.a */
/* compiled from: PG */
public abstract class C82298a implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "ASSIST_DATA_C_D_C_LATENCY";
        double doubleValue = mo75581b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo75581b();

    /* renamed from: c */
    public abstract String mo75582c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227084ci.mo6453a()).mo24824b(mo75581b().doubleValue(), str, str2, mo75582c(), Boolean.valueOf(mo75585f()));
    }

    /* renamed from: f */
    public abstract boolean mo75585f();
}
