...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.lb */
/* compiled from: PG */
public abstract class C82597lb implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_HOTWORD_DECISION_LOCAL_MDA";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "device_type";
        String c = mo75883c();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo75882b();

    /* renamed from: c */
    public abstract String mo75883c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f226977aS.mo6453a()).mo24822a(1, str, str2, mo75883c(), mo75882b());
    }
}
