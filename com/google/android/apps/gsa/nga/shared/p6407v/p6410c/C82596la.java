...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.la */
/* compiled from: PG */
public abstract class C82596la implements C82548jg {
    /* renamed from: c */
    public static C82594kz m131660c() {
        C82365cm cmVar = new C82365cm();
        cmVar.f225005a = "NGA_GSA_VIS_STATUS";
        return cmVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_GSA_VIS_STATUS";
    ...
    /* renamed from: b */
    public abstract String mo75878b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227066cB.mo6453a()).mo24822a(1, str, str2, mo75878b());
    }
}
