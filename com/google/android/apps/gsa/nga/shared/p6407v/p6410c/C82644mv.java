...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mv */
/* compiled from: PG */
public abstract class C82644mv implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_RECOGNITION_CONTEXT_PROVIDED";
        double doubleValue = mo76111b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76111b();

    /* renamed from: c */
    public abstract String mo76112c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f226953V.mo6453a()).mo24824b(mo76111b().doubleValue(), str, str2, mo76114f(), mo76112c());
    }

    /* renamed from: f */
    public abstract String mo76114f();
}
