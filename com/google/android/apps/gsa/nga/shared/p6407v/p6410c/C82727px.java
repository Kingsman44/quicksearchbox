...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.px */
/* compiled from: PG */
public abstract class C82727px implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "SPEEDBUMP_LATENCY";
        double doubleValue = mo76479b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76479b();

    /* renamed from: c */
    public abstract String mo76480c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227070cF.mo6453a()).mo24824b(mo76479b().doubleValue(), mo76480c(), str);
    }
}
