...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ks */
/* compiled from: PG */
public abstract class C82587ks implements C82548jg {
    /* renamed from: c */
    public static C82586kr m131630c() {
        C82357ce ceVar = new C82357ce();
        ceVar.f224988a = "NGA_FULFILLMENT_STATUS";
        return ceVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_FULFILLMENT_STATUS";
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227113o.mo6453a()).mo24822a(1, str, str2, Integer.valueOf(mo75852b()));
    }
}
