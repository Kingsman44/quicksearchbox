...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ih */
/* compiled from: PG */
public abstract class C82522ih implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "DID_QUERY_CLASSIFIER_LOADING_COUNT";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "resource_version";
        int c = mo76563c();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo76562b();

    /* renamed from: c */
    public abstract int mo76563c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227091cp.mo6453a()).mo24822a(1, str, Integer.valueOf(mo76563c()), Integer.valueOf(mo76562b()));
    }
}
