...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.is */
/* compiled from: PG */
public abstract class C82533is implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "GDD_TASK_SCHEDULER_TASK_COUNT";
        double doubleValue = mo75614b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo75614b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227098cw.mo6453a()).mo24824b(mo75614b().doubleValue(), str, str2);
    }
}
