...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mr */
/* compiled from: PG */
public abstract class C82640mr implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_PIE_TRIGGER_FAILURE_ELIGIBILITY";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "eligibility";
        String b = mo76086b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo76086b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f226975aQ.mo6453a()).mo24822a(1, str, str2, mo76086b());
    }
}
