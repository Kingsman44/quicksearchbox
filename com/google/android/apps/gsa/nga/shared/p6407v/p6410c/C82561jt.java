...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.jt */
/* compiled from: PG */
public abstract class C82561jt implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_COMPONENT_LIFECYCLE_STATUS";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "component";
        String b = mo75750b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo75750b();

    /* renamed from: c */
    public abstract boolean mo75751c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227009ay.mo6453a()).mo24822a(1, str, str2, mo75750b(), Boolean.valueOf(mo75751c()));
    }
}
