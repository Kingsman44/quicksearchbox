...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.lt */
/* compiled from: PG */
public abstract class C82615lt implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_MEMORY_LAST_TRIM_LEVEL";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "device_ram_gb";
        String c = mo75976c();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo75975b();

    /* renamed from: c */
    public abstract String mo75976c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227045bh.mo6453a()).mo24822a(1, str, str2, mo75976c(), Integer.valueOf(mo75975b()));
    }
}
