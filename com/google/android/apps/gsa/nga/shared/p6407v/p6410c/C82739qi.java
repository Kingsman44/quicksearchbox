...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.qi */
/* compiled from: PG */
public abstract class C82739qi implements C82548jg {
    /* renamed from: c */
    public static C82738qh m132343c() {
        C82508hu huVar = new C82508hu();
        huVar.f225460a = "WATCH_SUGGESTION_QUERY_STATUS";
        return huVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "WATCH_SUGGESTION_QUERY_STATUS";
    ...
    /* renamed from: b */
    public abstract String mo76544b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227054bq.mo6453a()).mo24822a(1, str, str2, mo76544b());
    }
}
