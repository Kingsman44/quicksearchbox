...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.os */
/* compiled from: PG */
public abstract class C82695os implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_WARM_ACTIONS_RESOURCE_FILE_STATUS";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "file_id";
        String b = mo76345b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo76345b();

    /* renamed from: c */
    public abstract boolean mo76346c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227025bN.mo6453a()).mo24822a(1, str, str2, mo76345b(), Boolean.valueOf(mo76346c()));
    }
}
