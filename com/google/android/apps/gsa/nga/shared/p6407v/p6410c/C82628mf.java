...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mf */
/* compiled from: PG */
public abstract class C82628mf implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_OPA_EVENT_ENQUEUE_DELAY_TIME";
        double doubleValue = mo76032b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76032b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227042be.mo6453a()).mo24824b(mo76032b().doubleValue(), str, str2);
    }
}
