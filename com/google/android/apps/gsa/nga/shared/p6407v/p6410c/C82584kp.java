...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.kp */
/* compiled from: PG */
public abstract class C82584kp implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_FULFILLMENT_ABORT_REASON_TYPED";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "abort_reason";
        int b = mo75840b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo75840b();

    /* renamed from: c */
    public abstract int mo75841c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227112n.mo6453a()).mo24822a(1, str, str2, Integer.valueOf(mo75840b()), Integer.valueOf(mo75841c()));
    }
}
