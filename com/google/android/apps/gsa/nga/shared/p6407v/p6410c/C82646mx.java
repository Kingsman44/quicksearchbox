...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mx */
/* compiled from: PG */
public abstract class C82646mx implements C82548jg {
    /* renamed from: c */
    public static C82645mw m131904c() {
        C82416ej ejVar = new C82416ej();
        ejVar.f225171a = "NGA_RELIABILITY_LOGGING";
        return ejVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_RELIABILITY_LOGGING";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "logging_status";
        String b = mo76118b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo76118b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f226985aa.mo6453a()).mo24822a(1, str, str2, mo76118b());
    }
}
