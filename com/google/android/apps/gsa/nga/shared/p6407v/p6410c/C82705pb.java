...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.pb */
/* compiled from: PG */
public abstract class C82705pb implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_WARM_ACTIONS_TRIGGER_SODA_EVENT_COUNT";
        double doubleValue = mo76389c().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo76388b();

    /* renamed from: c */
    public abstract Double mo76389c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        double doubleValue = mo76389c().doubleValue();
        int b = mo76388b();
        ((C19569f) ifVar.f227035bX.mo6453a()).mo24824b(doubleValue, str, str2, Integer.valueOf(b), mo76391f());
    }

    /* renamed from: f */
    public abstract String mo76391f();
}
