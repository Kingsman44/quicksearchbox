...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.le */
/* compiled from: PG */
public abstract class C82600le implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_ICING_EMAIL_AVAILABLE_KEYWORDS_COUNT";
        double doubleValue = mo75901b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo75901b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f226964aF.mo6453a()).mo24824b(mo75901b().doubleValue(), str, str2);
    }
}
