...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.pv */
/* compiled from: PG */
public abstract class C82725pv implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "SODA_SESSION_DURATION";
        double doubleValue = mo76472b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76472b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227005au.mo6453a()).mo24824b(mo76472b().doubleValue(), str, str2);
    }
}
