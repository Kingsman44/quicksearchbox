...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.pa */
/* compiled from: PG */
public abstract class C82704pa implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_WARM_ACTIONS_TRIGGER_MEAN_AUDIO_LEVEL_SINCE_FINAL";
        double doubleValue = mo76383c().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo76382b();

    /* renamed from: c */
    public abstract Double mo76383c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        double doubleValue = mo76383c().doubleValue();
        int b = mo76382b();
        ((C19569f) ifVar.f227077cb.mo6453a()).mo24824b(doubleValue, str, str2, Integer.valueOf(b), mo76385f());
    }

    /* renamed from: f */
    public abstract String mo76385f();
}
