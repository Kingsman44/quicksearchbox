...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.mb */
/* compiled from: PG */
public abstract class C82624mb implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_NETWORK_UPSTREAM_BANDWIDTH";
        double doubleValue = mo76014b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76014b();

    /* renamed from: c */
    public abstract String mo76015c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f226981aW.mo6453a()).mo24824b(mo76014b().doubleValue(), str, str2, mo76015c(), mo76017f());
    }

    /* renamed from: f */
    public abstract String mo76017f();
}
