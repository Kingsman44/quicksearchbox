...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.io */
/* compiled from: PG */
public abstract class C82529io implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "FETCH_ASSIST_DATA_LATENCY";
        double doubleValue = mo75599b().doubleValue();
        aec.copyOnWrite();
        ...
        aee.f158449a |= 1;
        aee.f158452d = "assist_data_required_type";
        String c = mo75600c();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo75599b();

    /* renamed from: c */
    public abstract String mo75600c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227083ch.mo6453a()).mo24824b(mo75599b().doubleValue(), str, mo75600c(), Boolean.valueOf(mo75602f()));
    }

    /* renamed from: f */
    public abstract boolean mo75602f();
}
