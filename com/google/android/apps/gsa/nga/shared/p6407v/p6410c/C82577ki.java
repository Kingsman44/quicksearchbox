...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ki */
/* compiled from: PG */
public abstract class C82577ki implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_FILE_PROVIDER_LATENCY";
        double doubleValue = mo75801f().doubleValue();
        aec.copyOnWrite();
        ...
        aee.f158449a |= 1;
        aee.f158452d = "file_provider_source";
        int b = mo75798b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo75798b();

    /* renamed from: c */
    public abstract int mo75799c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227065cA.mo6453a()).mo24824b(mo75801f().doubleValue(), str, str2, Integer.valueOf(mo75798b()), Integer.valueOf(mo75799c()), Boolean.valueOf(mo75802g()));
    }

    /* renamed from: f */
    public abstract Double mo75801f();

    /* renamed from: g */
    public abstract boolean mo75802g();
}
