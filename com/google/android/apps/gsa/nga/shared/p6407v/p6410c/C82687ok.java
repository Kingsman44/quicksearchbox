...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ok */
/* compiled from: PG */
public abstract class C82687ok implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_WARM_ACTIONS_ANSWERED_CALL_DURATION";
        double doubleValue = mo76307b().doubleValue();
        aec.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract Double mo76307b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227079cd.mo6453a()).mo24824b(mo76307b().doubleValue(), str, str2);
    }
}
