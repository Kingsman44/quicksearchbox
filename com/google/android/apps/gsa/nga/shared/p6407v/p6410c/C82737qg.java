...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.qg */
/* compiled from: PG */
public abstract class C82737qg implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aee3.f158449a |= 1;
        aee3.f158452d = "vi_intent_action";
        String b = mo76537b();
        aed2.copyOnWrite();
        ...
        aee5.f158449a |= 1;
        aee5.f158452d = "should_only_create_session";
        boolean f = mo76540f();
        aed3.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo76537b();

    /* renamed from: c */
    public abstract boolean mo76538c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        boolean c = mo76538c();
        ((C19567d) ifVar.f227082cg.mo6453a()).mo24822a(1, Boolean.valueOf(c), mo76537b(), str, Boolean.valueOf(mo76540f()));
    }

    /* renamed from: f */
    public abstract boolean mo76540f();
}
