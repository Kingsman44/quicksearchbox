...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.jo */
/* compiled from: PG */
public abstract class C82556jo implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_CLIENT_CONVERSATION_DONE_DELAY";
        double doubleValue = mo75726c().doubleValue();
        aec.copyOnWrite();
        ...
        aee.f158449a |= 1;
        aee.f158452d = "configured_timeout";
        int b = mo75725b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract int mo75725b();

    /* renamed from: c */
    public abstract Double mo75726c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19569f) ifVar.f227104f.mo6453a()).mo24824b(mo75726c().doubleValue(), Integer.valueOf(mo75725b()), Boolean.valueOf(mo75728f()));
    }

    /* renamed from: f */
    public abstract boolean mo75728f();
}
