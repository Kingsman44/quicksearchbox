...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.pn */
/* compiled from: PG */
public abstract class C82717pn implements C82548jg {
    /* renamed from: c */
    public static C82716pm m132233c() {
        C82486gz gzVar = new C82486gz();
        gzVar.f225386a = "PIE_TRIGGERING_INFRA";
        return gzVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "PIE_TRIGGERING_INFRA";
    ...
    /* renamed from: b */
    public abstract String mo76442b();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f227018bG.mo6453a()).mo24822a(1, str, mo76442b());
    }
}
