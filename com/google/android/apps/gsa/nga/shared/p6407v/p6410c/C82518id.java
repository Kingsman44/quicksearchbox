...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.id */
/* compiled from: PG */
public abstract class C82518id implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "DID_EMPTY_PREVIOUS_QUERY_EVENT";
        ...
        aee3.f158449a |= 1;
        aee3.f158452d = "previous_query_is_present";
        boolean c = mo76559c();
        aed2.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo76558b();

    /* renamed from: c */
    public abstract boolean mo76559c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        ((C19567d) ifVar.f226948Q.mo6453a()).mo24822a(1, str, str2, mo76558b(), Boolean.valueOf(mo76559c()));
    }
}
