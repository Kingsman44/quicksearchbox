...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.ly */
/* compiled from: PG */
public abstract class C82620ly implements C82548jg {
    /* renamed from: a */
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_NATIVE_LIBRARY_LOADING_STATUS";
        aed aed = (aed) aee.f158447e.createBuilder();
        aed.copyOnWrite();
        aee aee = (aee) aed.instance;
        aee.f158449a |= 1;
        aee.f158452d = "library_name";
        String b = mo75997b();
        aed.copyOnWrite();
    ...
    /* renamed from: b */
    public abstract String mo75997b();

    /* renamed from: c */
    public abstract String mo75998c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        String b = mo75997b();
        boolean f = mo76000f();
        ((C19567d) ifVar.f227081cf.mo6453a()).mo24822a(1, str, str2, b, Boolean.valueOf(f), mo75998c());
    }

    /* renamed from: f */
    public abstract boolean mo76000f();
}
