...
/* renamed from: com.google.android.apps.gsa.nga.shared.v.c.om */
/* compiled from: PG */
public abstract class C82689om implements C82548jg {
    /* renamed from: f */
    public static C82688ol m132105f() {
        C82458fy fyVar = new C82458fy();
        fyVar.f225305a = "NGA_WARM_ACTIONS_CONTEXT_EVENT_DROPPED";
        return fyVar;
    }
    ...
    public final aef mo75580a() {
        ...
        aef.f158455a |= 1;
        aef.f158456b = "NGA_WARM_ACTIONS_CONTEXT_EVENT_DROPPED";
    ...
    /* renamed from: b */
    public abstract int mo76313b();

    /* renamed from: c */
    public abstract String mo76314c();
    ...
    public final void mo75584e(String str, String str2, C83311if ifVar) {
        int b = mo76313b();
        ((C19567d) ifVar.f227029bR.mo6453a()).mo24822a(1, str, str2, Integer.valueOf(b), mo76314c());
    }
}
