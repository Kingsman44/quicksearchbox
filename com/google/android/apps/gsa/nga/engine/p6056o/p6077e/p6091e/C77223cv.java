...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.cv */
/* compiled from: PG */
public final /* synthetic */ class C77223cv implements C77193bs {

    /* renamed from: a */
    public final /* synthetic */ C77225cx f213056a;

    public /* synthetic */ C77223cv(C77225cx cxVar) {
        this.f213056a = cxVar;
    }

    /* renamed from: a */
    public final C60870cx mo72467a(C76590bg bgVar, C74965n nVar, C58485gu guVar) {
        C77225cx cxVar = this.f213056a;
        if (!nVar.mo71328c().mo71266e()) {
            cxVar.f213058a.mo76648a(nVar.mo71336k(), C82835ce.MULTIPLE_ALARMS_RINGING, C83044e.f226656a);
            return C81442m.f222851a;
        }
        C80399l lVar = (C80399l) C80401n.f220656k.createBuilder();
        lVar.mo74319k(23212);
        C51593nl nlVar = (C51593nl) C51594nm.f134474f.createBuilder();
        nlVar.mo53648b((C58485gu) Collection.EL.stream(guVar).map(C77224cw.f213057a).collect(C58370cn.f155946a));
        nlVar.copyOnWrite();
