...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.b.e.a */
/* compiled from: PG */
public final class C76876a implements C76591c {

    /* renamed from: a */
    private static final C58974d f212305a = C58974d.m91136j();

    /* renamed from: a */
    public final C76594f mo71711a() {
        C76593e h = C76594f.m123238h();
        h.mo72246e(Optional.m71637of(C82831ca.MAPS_NAVIGATE_TO_LOCATION));
        h.mo72277g("Navigate_to_location", C90126fx.f251324gf);
        h.mo72244c(C58485gu.m89846n("Navigate_to_location"));
        ((C76541a) h).f211766c = 11101;
        return h.mo72276f();
    }
    ...
    public final C60870cx mo71712b(C76590bg bgVar, C74965n nVar) {
        ...
        if (g.isEmpty()) {
            ((C58970a) ((C58970a) f212305a.mo56226d()).mo56372aa(3779)).mo56386p("Destination not found");
            return C60856cj.m92900i((C80401n) lVar.build());
        }
        String str = ((C63408ai) g.get()).f171356d;
        if (TextUtils.isEmpty(str)) {
            ((C58970a) ((C58970a) f212305a.mo56226d()).mo56372aa(3778)).mo56386p("Destination empty");
            return C60856cj.m92900i((C80401n) lVar.build());
        }
        C81442m.m129557s(lVar, t.u(new Intent("android.intent.action.VIEW", Uri.parse("google.navigation:q=".concat(String.valueOf(str)))).setPackage("com.google.android.apps.maps").addFlags(32768), 1, nVar.mo71336k(), false, false));
        lVar.mo74319k(23133);
        lVar.mo74319k(90660);
        return C60856cj.m92900i((C80401n) lVar.build());
    }
