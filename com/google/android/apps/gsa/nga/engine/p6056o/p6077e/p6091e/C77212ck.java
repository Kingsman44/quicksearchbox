...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.ck */
/* compiled from: PG */
public final /* synthetic */ class C77212ck implements C77193bs {

    /* renamed from: a */
    public final /* synthetic */ C77215cn f213038a;

    public /* synthetic */ C77212ck(C77215cn cnVar) {
        this.f213038a = cnVar;
    }
    ...
    public final C60870cx mo72467a(C76590bg bgVar, C74965n nVar, C58485gu guVar) {
        ...
        C77215cn cnVar = this.f213038a;
        Optional map = bgVar2.mo72270l("time_to_remove").map(C77214cm.f213040a);
        if (guVar.size() != 1) {
            cnVar.f213042b.mo76648a(nVar.mo71336k(), C82835ce.QUANTIFIERS_NOT_IMPLEMENTED, C83044e.f226656a);
            return C81442m.f222851a;
        } else if (!map.isPresent()) {
            cnVar.f213042b.mo76648a(nVar.mo71336k(), C82835ce.TIME_TO_ADD_NOT_PROVIDED, C83044e.f226656a);
            return C81442m.f222851a;
        } else if (!nVar.mo71328c().mo71266e()) {
            cnVar.f213042b.mo76648a(nVar.mo71336k(), C82835ce.SUPPORTED_APPLICATION_NOT_FOUND, C83044e.f226656a);
            return C81442m.f222851a;
        } else {
            ...
            if ((nkVar2.f134465b == 4 ? ((Long) nkVar2.f134466c).longValue() : 0) == nkVar2.f134469f) {
                C81442m.m129557s(lVar, t.r(cnVar.f213041a.mo75121a(nVar.mo71342q()).getString(R.string.nga_productivity_remove_time_from_running_pause_timer_response, new Object[0])));
                return C60856cj.m92900i((C80401n) lVar.build());
            }
            Duration duration = (Duration) bgVar2.mo72270l("time_to_remove").map(C77214cm.f213040a).get();
