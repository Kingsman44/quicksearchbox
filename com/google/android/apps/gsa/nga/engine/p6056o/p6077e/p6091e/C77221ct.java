...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.ct */
/* compiled from: PG */
public final class C77221ct implements C76591c {

    /* renamed from: a */
    public final C83216f f213053a;

    /* renamed from: b */
    private final C77196bv f213054b;

    public C77221ct(C77196bv bvVar, C83251g gVar) {
        this.f213054b = bvVar;
        this.f213053a = gVar.mo76652a(C82831ca.RESET_TIMER);
    }

    /* renamed from: a */
    public final C76594f mo71711a() {
        C76593e h = C76594f.m123238h();
        h.mo72246e(Optional.m71637of(C82831ca.RESET_TIMER));
        h.mo72245d(ac.a());
        h.mo72277g("Reset_timer", C90126fx.f251440ip);
        h.mo72244c(C58485gu.m89846n("Reset_timer"));
        ((C76541a) h).f211766c = 10917;
        return h.mo72276f();
    }

    /* renamed from: b */
    public final C60870cx mo71712b(C76590bg bgVar, C74965n nVar) {
        C77191bq h = C77192br.m123911h(this.f213054b);
        C77279z zVar = (C77279z) h;
        zVar.f213152e = this.f213053a;
        h.mo72483b(c.c);
        zVar.f213149b = C77218cq.f213050a;
        zVar.f213150c = new C77219cr(this);
