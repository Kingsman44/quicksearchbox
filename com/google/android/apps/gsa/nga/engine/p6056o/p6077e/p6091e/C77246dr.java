...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.dr */
/* compiled from: PG */
public final class C77246dr implements C76591c {

    /* renamed from: a */
    public static final C58974d f213092a = C58974d.m91136j();

    /* renamed from: b */
    public final C81515c f213093b;

    /* renamed from: c */
    public final C83216f f213094c;

    /* renamed from: d */
    private final C22871g f213095d;

    public C77246dr(C81515c cVar, C22871g gVar, C83251g gVar2) {
        this.f213093b = cVar;
        this.f213095d = gVar;
        this.f213094c = gVar2.mo76652a(C82831ca.START_STOPWATCH);
    }
    ...
    public final C76594f mo71711a() {
        ...
        h.mo72245d(ac.a());
        h.mo72246e(Optional.m71637of(C82831ca.START_STOPWATCH));
        h.mo72277g("Start_stopwatch", C90126fx.f251414iP);
        ((C76541a) h).f211766c = 10907;
        h.mo72244c(C58485gu.m89846n("Start_stopwatch"));
        return h.mo72276f();
    }
    ...
    public final C60870cx mo71712b(C76590bg bgVar, C74965n nVar) {
        ...
        if (c.mo71266e()) {
            return this.f213095d.mo28209i(c.mo71262a(), "[NGA] StartStopwatchFulfiller.fulfill", new C77245dq(this, nVar));
        }
        this.f213094c.mo76648a(nVar.mo71336k(), C82835ce.SUPPORTED_APPLICATION_NOT_FOUND, C83044e.f226656a);
