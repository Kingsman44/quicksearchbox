...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.cf */
/* compiled from: PG */
public final class C77207cf implements C76591c {

    /* renamed from: a */
    public static final C58974d f213029a = C58974d.m91136j();

    /* renamed from: b */
    public final C81515c f213030b;

    /* renamed from: c */
    public final C83216f f213031c;

    /* renamed from: d */
    private final C22871g f213032d;

    public C77207cf(C81515c cVar, C22871g gVar, C83251g gVar2) {
        this.f213030b = cVar;
        this.f213032d = gVar;
        this.f213031c = gVar2.mo76652a(C82831ca.PAUSE_STOPWATCH);
    }
    ...
    public final C76594f mo71711a() {
        ...
        h.mo72245d(ac.a());
        h.mo72246e(Optional.m71637of(C82831ca.PAUSE_STOPWATCH));
        h.mo72277g("Pause_stopwatch", C90126fx.f251315gW);
        ((C76541a) h).f211766c = 10908;
        h.mo72244c(C58485gu.m89846n("Pause_stopwatch"));
        return h.mo72276f();
    }
    ...
    public final C60870cx mo71712b(C76590bg bgVar, C74965n nVar) {
        ...
        if (c.mo71266e()) {
            return this.f213032d.mo28209i(c.mo71262a(), "[NGA] PauseStopwatchFulfiller.fulfill", new C77206ce(this, nVar));
        }
        this.f213031c.mo76648a(nVar.mo71336k(), C82835ce.SUPPORTED_APPLICATION_NOT_FOUND, C83044e.f226656a);
