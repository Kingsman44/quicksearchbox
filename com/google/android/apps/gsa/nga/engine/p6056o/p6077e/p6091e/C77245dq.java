...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.dq */
/* compiled from: PG */
public final /* synthetic */ class C77245dq implements C22864c {

    /* renamed from: a */
    public final /* synthetic */ C77246dr f213090a;

    /* renamed from: b */
    public final /* synthetic */ C74965n f213091b;

    public /* synthetic */ C77245dq(C77246dr drVar, C74965n nVar) {
        this.f213090a = drVar;
        this.f213091b = nVar;
    }
    ...
    public final Object mo17879a(Object obj) {
        C77246dr drVar = this.f213090a;
        C74965n nVar = this.f213091b;
        C58485gu b = ((C74885bc) obj).mo71274b();
        if (b.size() != 1) {
            ((C58970a) ((C58970a) C77246dr.f213092a.mo56226d()).mo56372aa(3844)).mo56387q("Found %d stopwatches, can only handle exactly 1.", b.size());
            drVar.f213094c.mo76648a(nVar.mo71336k(), C82835ce.QUANTIFIERS_NOT_IMPLEMENTED, C83044e.f226656a);
        ...
        if (a.equals(C51559me.RUNNING)) {
            ...
            C81442m.m129557s(lVar, t.r(drVar.f213093b.mo75121a(nVar.mo71342q()).getString(R.string.nga_productivity_stopwatch_running_already, new Object[0])));
        ...
        C81442m.m129557s(lVar, t.o("stopwatch.START_STOPWATCH", (C51562mh) mgVar2.build()));
        return (C80401n) lVar.build();
    }
}
