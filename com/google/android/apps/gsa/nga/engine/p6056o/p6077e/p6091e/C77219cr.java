...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.cr */
/* compiled from: PG */
public final /* synthetic */ class C77219cr implements C77193bs {

    /* renamed from: a */
    public final /* synthetic */ C77221ct f213051a;

    public /* synthetic */ C77219cr(C77221ct ctVar) {
        this.f213051a = ctVar;
    }

    /* renamed from: a */
    public final C60870cx mo72467a(C76590bg bgVar, C74965n nVar, C58485gu guVar) {
        C77221ct ctVar = this.f213051a;
        if (!nVar.mo71328c().mo71266e()) {
            ctVar.f213053a.mo76648a(nVar.mo71336k(), C82835ce.SUPPORTED_APPLICATION_NOT_FOUND, C83044e.f226656a);
            return C81442m.f222851a;
        }
        C80399l lVar = (C80399l) C80401n.f220656k.createBuilder();
        lVar.mo74319k(23210);
        C51593nl nlVar = (C51593nl) C51594nm.f134474f.createBuilder();
        nlVar.mo53648b((C58485gu) Collection.EL.stream(guVar).map(C77220cs.f213052a).collect(C58370cn.f155946a));
        nlVar.copyOnWrite();
