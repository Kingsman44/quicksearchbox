...
/* renamed from: com.google.android.apps.gsa.nga.engine.o.e.e.cd */
/* compiled from: PG */
public final class C77205cd implements C76591c {

    /* renamed from: a */
    public static final C58974d f213023a = C58974d.m91136j();

    /* renamed from: b */
    public final C83216f f213024b;

    /* renamed from: c */
    public final C81515c f213025c;

    /* renamed from: d */
    private final C22871g f213026d;

    public C77205cd(C81515c cVar, C22871g gVar, C83251g gVar2) {
        this.f213025c = cVar;
        this.f213026d = gVar;
        this.f213024b = gVar2.mo76652a(C82831ca.LAP_STOPWATCH);
    }
    ...
    public final C76594f mo71711a() {
        ...
        h.mo72245d(ac.a());
        h.mo72246e(Optional.m71637of(C82831ca.LAP_STOPWATCH));
        h.mo72277g("Lap_stopwatch", C90126fx.f251246fG);
        ((C76541a) h).f211766c = 10920;
        h.mo72244c(C58485gu.m89846n("Lap_stopwatch"));
        return h.mo72276f();
    }
    ...
    public final C60870cx mo71712b(C76590bg bgVar, C74965n nVar) {
        ...
        if (c.mo71266e()) {
            return this.f213026d.mo28209i(c.mo71262a(), "[NGA] LapStopwatchFulfiller.fulfill", new C77202ca(this, nVar));
        }
        this.f213024b.mo76648a(nVar.mo71336k(), C82835ce.SUPPORTED_APPLICATION_NOT_FOUND, C83044e.f226656a);
