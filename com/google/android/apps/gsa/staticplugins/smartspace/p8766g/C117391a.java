...
/* renamed from: com.google.android.apps.gsa.staticplugins.smartspace.g.a */
/* compiled from: PG */
public final class C117391a implements C117405i {

    /* renamed from: a */
    private final C86124t f325878a;

    /* renamed from: b */
    private final C21370a f325879b;

    public C117391a(C86124t tVar, C21370a aVar) {
        this.f325878a = tVar;
        this.f325879b = aVar;
    }
    ...
    public final C60870cx mo103283c(Object obj) {
        ...
        if (mVar.f256827b.isEmpty() && mVar.f256828c.isEmpty()) {
            return C60856cj.m92900i(new C117383a(C50794cr.ALARM));
        }
        long b = this.f325879b.mo26870b();
        ...
        doVar5.f132304a |= 512;
        C50794cr crVar = C50794cr.ALARM;
        cnVar.copyOnWrite();
        C50818do doVar6 = (C50818do) cnVar.instance;
        doVar6.f132315l = crVar.f132222T;
        doVar6.f132304a |= 1024;
        if (this.f325878a.mo79746e(C89985ax.f246715aw)) {
            pVar = C50731p.START_ACTIVITY;
        } else {
            pVar = C50731p.BROADCAST;
        }
        Intent c = C92122r.m151185c(mVar.f256833h, C50794cr.ALARM, pVar, false);
    ...
    public final boolean mo103285e(Object obj) {
        ...
        if (C50794cr.m85938a(a - 1) == C50794cr.ALARM) {
            return true;
        }
        return false;
    }
