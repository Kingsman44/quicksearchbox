...
/* renamed from: com.google.android.apps.gsa.staticplugins.smartspace.g.y */
/* compiled from: PG */
public final class C117421y implements C117405i {

    /* renamed from: a */
    private final C86124t f325925a;

    /* renamed from: b */
    private final C21370a f325926b;

    public C117421y(C86124t tVar, C21370a aVar) {
        this.f325925a = tVar;
        this.f325926b = aVar;
    }
    ...
    public final C60870cx mo103283c(Object obj) {
        ...
        if (mVar.f256827b.isEmpty() && mVar.f256828c.isEmpty()) {
            return C60856cj.m92900i(new C117383a(C50794cr.TIPS));
        }
        if (mVar.f256827b.isEmpty() || mVar.f256828c.isEmpty()) {
            C58976aa aaVar = C58975e.f156826a;
            return C60856cj.m92900i(new C117383a());
        }
        long b = this.f325926b.mo26870b();
        ...
        if (this.f325925a.mo79746e(C89985ax.f246715aw)) {
    ...
    public final boolean mo103285e(Object obj) {
        ...
        if (C50794cr.m85938a(a - 1) == C50794cr.TIPS) {
            return true;
        }
        return false;
    }
