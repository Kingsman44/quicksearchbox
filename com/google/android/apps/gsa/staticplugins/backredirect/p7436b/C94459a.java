package com.google.android.apps.gsa.staticplugins.backredirect.p7436b;
...
/* renamed from: com.google.android.apps.gsa.staticplugins.backredirect.b.a */
/* compiled from: PG */
public final class C94459a implements C86686h {

    /* renamed from: a */
    private static final C59071e f264059a = C59071e.m91332i("com.google.android.apps.gsa.staticplugins.backredirect.b.a");

    /* renamed from: c */
    private final Context f264060c;

    /* renamed from: d */
    private final C91097g f264061d;

    public C94459a(Context context, C91097g gVar) {
        this.f264060c = context;
        this.f264061d = gVar;
    }
    ...
    public final void mo80293f(long j, ClientEventData clientEventData, C86681c cVar) {
        ...
        if (a.ordinal() != 211) {
            C59104x c = f264059a.mo56225c();
            c.mo56378ag(C58975e.f156826a, "BackRedirectSessCtrl");
            ((C59052c) ((C59052c) c).mo56372aa(14450)).mo56386p("Unsupported event id");
            return;
        }
        Intent intent = (Intent) clientEventData.mo81912b(Intent.class);
        intent.setClass(this.f264060c, BackRedirectActivity.class);
        intent.addFlags(268435456);
        intent.addFlags(32768);
        this.f264061d.mo65089a(intent);
    }
