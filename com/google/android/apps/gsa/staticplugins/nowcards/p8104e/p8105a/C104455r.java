...
/* renamed from: com.google.android.apps.gsa.staticplugins.nowcards.e.a.r */
/* compiled from: PG */
public final class C104455r implements C23113i {

    /* renamed from: a */
    private final C104453p f290577a;

    public C104455r(C104453p pVar) {
        this.f290577a = pVar;
    }

    /* renamed from: a */
    public final void mo28561a(String str, String str2, Parcelable parcelable) {
        if ("CarouselModuleEventsDispatcher".equals(str2) && (parcelable instanceof Bundle)) {
            ...
            if (str.equals("dismissEntry_com.google.android.apps.sidekick.quantum.Modules.ClientAction")) {
                this.f290577a.mo94166iX((C9141ad) new C23271p(C9141ad.f31521K.getParserForType(), C62921ba.m95368a(), C9141ad.f31521K).mo28733b("clientAction", pVar));
            } else if (str.equals("dismissSnackbar")) {
                this.f290577a.mo94167iY();
            } else if (str.equals("logVideoWatchData_com.google.logs.proto.now.video.VideoWatchDataProto.VideoWatchData")) {
                ((C104535ac) this.f290577a).f290762i.mo85745e((C54806z) new C23271p(C54806z.f143773n.getParserForType(), C62921ba.m95368a(), C54806z.f143773n).mo28733b("videoWatchData", pVar));
            } else if (str.equals("maybeShowTooltip_int_com.google.android.apps.sidekick.quantum.Modules.BoundingBox")) {
                this.f290577a.mo94164h(Integer.valueOf(pVar.f63472a.getInt("tipId")).intValue(), (C9268l) new C23271p(C9268l.f32065f.getParserForType(), C62921ba.m95368a(), C9268l.f32065f).mo28733b("boundingBox", pVar));
            } else if (str.equals("onAdTouchEvent_android.view.MotionEvent")) {
                this.f290577a.mo94165i((MotionEvent) new C23269n().mo28733b("motionEvent", pVar));
            } else if (str.equals("onBackOfCardStateUpdated_boolean")) {
                this.f290577a.mo94161e(Boolean.valueOf(pVar.f63472a.getBoolean("hasSwappedHeaderAction")).booleanValue());
            } else if (str.equals("onInjectCollectionComponents_int")) {
                this.f290577a.mo94158j(Integer.valueOf(pVar.f63472a.getInt("minClickTimeSeconds")).intValue());
                ...
                this.f290577a.mo94168k(string, (C7850mg) new C23271p(C7850mg.f27512e.getParserForType(), C62921ba.m95368a(), C7850mg.f27512e).mo28733b("oldState", pVar), (C7850mg) new C23271p(C7850mg.f27512e.getParserForType(), C62921ba.m95368a(), C7850mg.f27512e).mo28733b("newState", pVar), booleanValue);
            } else if (str.equals("onSearchAction_com.google.android.libraries.gsa.monet.shared.ProtoParcelable")) {
                this.f290577a.mo94169l((ProtoParcelable) new C23269n().mo28733b("clientAction", pVar));
                ...
                string2.getClass();
                this.f290577a.mo94159c((C7530ar) new C23271p(C7530ar.f26069f.getParserForType(), C62921ba.m95368a(), C7530ar.f26069f).mo28733b("adDismissSurveyAction", pVar), string2);
                ...
                string3.getClass();
                this.f290577a.mo94170m(Integer.valueOf(pVar.f63472a.getInt("x")).intValue(), Integer.valueOf(pVar.f63472a.getInt("y")).intValue(), (ProtoParcelable) new C23269n().mo28733b("reactAction", pVar), string3);
                ...
                string4.getClass();
                this.f290577a.mo94171n((C7593ct) new C23271p(C7593ct.f26245g.getParserForType(), C62921ba.m95368a(), C7593ct.f26245g).mo28733b("reportAction", pVar), string4);
            } else if (str.equals("onShowWhyThisAd_com.google.geo.sidekick.ClientActionProto.WhyThisAdAction")) {
                this.f290577a.mo94160d((C7621du) new C23271p(C7621du.f26333f.getParserForType(), C62921ba.m95368a(), C7621du.f26333f).mo28733b("whyThisAdAction", pVar));
                ...
                this.f290577a.mo94172o((C9222dd) new C23271p(C9222dd.f31875c.getParserForType(), C62921ba.m95368a(), C9222dd.f31875c).mo28733b("saveAction", pVar), string5, booleanValue2, booleanValue3, booleanValue4);
            } else if (str.equals("onToggleToDefaultState_java.lang.String")) {
                String string6 = pVar.f63472a.getString("multiStateIconId");
                string6.getClass();
                ((C104535ac) this.f290577a).mo94244M(string6, 1);
            } else if (str.equals("openSilkMediaPane_java.lang.String")) {
                String string7 = pVar.f63472a.getString("url");
                string7.getClass();
                this.f290577a.mo94174q(string7);
                ...
                this.f290577a.mo94175r((ProtoParcelable) new C23269n().mo28733b("clientAction", pVar), e);
            } else if (str.equals("openVideoInNewApp_com.google.android.libraries.gsa.monet.shared.ProtoParcelable")) {
                this.f290577a.mo94176s((ProtoParcelable) new C23269n().mo28733b("playVideoAction", pVar));
            } else if (str.equals("openVideoSettings")) {
                this.f290577a.mo94177t();
            } else if (str.equals("recordVeAction_com.google.geo.sidekick.CardActionProto.CardAction")) {
                ((C104535ac) this.f290577a).f290762i.mo85744d((C8194z) new C23271p(C8194z.f28777k.getParserForType(), C62921ba.m95368a(), C8194z.f28777k).mo28733b("cardAction", pVar));
                ...
                this.f290577a.mo94178u((C69399au) dVar.f63738a[i]);
                ...
                this.f290577a.mo94179v(string8, (C7642eo) dVar2.f63738a[i2]);
                ...
                this.f290577a.mo94180w(string9, string10, (C7642eo) dVar3.f63738a[i3]);
            }
        }
    }
}
