...
/* renamed from: com.google.android.apps.gsa.staticplugins.nowcards.e.a.ac */
/* compiled from: PG */
public final class C104426ac implements C104425ab {

    /* renamed from: a */
    private final C23112h f290562a;

    public C104426ac(C23112h hVar) {
        this.f290562a = hVar;
    }
    ...
    public final void mo94159c(C7530ar arVar, String str) {
        ...
        this.f290562a.mo28345s("onShowAdDismissSurvey_com.google.geo.sidekick.ClientActionProto.AdDismissSurveyAction_java.lang.String", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94160d(C7621du duVar) {
        ...
        this.f290562a.mo28345s("onShowWhyThisAd_com.google.geo.sidekick.ClientActionProto.WhyThisAdAction", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94161e(boolean z) {
        ...
        this.f290562a.mo28345s("onBackOfCardStateUpdated_boolean", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94162f(C8194z zVar) {
        ...
        this.f290562a.mo28345s("recordVeAction_com.google.geo.sidekick.CardActionProto.CardAction", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94163g(C54806z zVar) {
        ...
        this.f290562a.mo28345s("logVideoWatchData_com.google.logs.proto.now.video.VideoWatchDataProto.VideoWatchData", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94164h(int i, C9268l lVar) {
        ...
        this.f290562a.mo28345s("maybeShowTooltip_int_com.google.android.apps.sidekick.quantum.Modules.BoundingBox", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94165i(MotionEvent motionEvent) {
        ...
        this.f290562a.mo28345s("onAdTouchEvent_android.view.MotionEvent", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94166iX(C9141ad adVar) {
        ...
        this.f290562a.mo28345s("dismissEntry_com.google.android.apps.sidekick.quantum.Modules.ClientAction", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94158j(int i) {
        ...
        this.f290562a.mo28345s("onInjectCollectionComponents_int", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94168k(String str, C7850mg mgVar, C7850mg mgVar2, boolean z) {
        ...
        this.f290562a.mo28345s("onMultiStateIconNextState_java.lang.String_com.google.geo.sidekick.MultiState.MultiStateIcon.StateData_com.google.geo.sidekick.MultiState.MultiStateIcon.StateData_boolean", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94169l(ProtoParcelable protoParcelable) {
        ...
        this.f290562a.mo28345s("onSearchAction_com.google.android.libraries.gsa.monet.shared.ProtoParcelable", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94170m(int i, int i2, ProtoParcelable protoParcelable, String str) {
        ...
        bundle.putString("multiStateIconId", str);
        this.f290562a.mo28345s("onShowReactionWidget_int_int_com.google.android.libraries.gsa.monet.shared.ProtoParcelable_java.lang.String", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94171n(C7593ct ctVar, String str) {
        ...
        bundle.putString("actionTakenMessage", str);
        this.f290562a.mo28345s("onShowReportContentDialog_com.google.geo.sidekick.ClientActionProto.ReportAction_java.lang.String", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94172o(C9222dd ddVar, String str, boolean z, boolean z2, boolean z3) {
        ...
        this.f290562a.mo28345s("onToggleSaveAction_com.google.android.apps.sidekick.quantum.Modules.SaveAction_java.lang.String_boolean_boolean_boolean", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94173p(String str) {
        Bundle bundle = new Bundle();
        bundle.putString("multiStateIconId", str);
        this.f290562a.mo28345s("onToggleToDefaultState_java.lang.String", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94174q(String str) {
        ...
        this.f290562a.mo28345s("openSilkMediaPane_java.lang.String", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94175r(ProtoParcelable protoParcelable, C58833ax axVar) {
        ...
        this.f290562a.mo28345s("openUrl_com.google.android.libraries.gsa.monet.shared.ProtoParcelable_com.google.common.base.Optional<java.lang.Long>", "ModuleEventsDispatcher", bundle);
    }
    ...
    public final void mo94176s(ProtoParcelable protoParcelable) {
        ...
        this.f290562a.mo28345s("openVideoInNewApp_com.google.android.libraries.gsa.monet.shared.ProtoParcelable", "ModuleEventsDispatcher", bundle);
    }

    /* renamed from: t */
    public final void mo94177t() {
        this.f290562a.mo28345s("openVideoSettings", "ModuleEventsDispatcher", new Bundle());
    }
