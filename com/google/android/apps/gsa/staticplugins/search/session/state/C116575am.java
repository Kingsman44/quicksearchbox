...
/* renamed from: com.google.android.apps.gsa.staticplugins.search.session.state.am */
/* compiled from: PG */
public final class C116575am extends C116780ib {

    /* renamed from: a */
    private static final C59071e f323295a = C59071e.m91332i("com.google.android.apps.gsa.staticplugins.search.session.state.am");

    /* renamed from: b */
    private final SparseArray f323296b = new SparseArray();

    public C116575am(C68214a aVar) {
        super(aVar, 183);
    }
    ...
    /* renamed from: e */
    public final ClientEventData mo102781e(int i) {
        ClientEventData clientEventData = (ClientEventData) this.f323296b.get(i);
        if (clientEventData != null) {
            this.f323296b.remove(i);
        }
    ...
    public final void mo17602gS(C91006f fVar) {
        ...
        for (int i = 0; i < this.f323296b.size(); i++) {
            ClientEventData clientEventData = (ClientEventData) this.f323296b.get(this.f323296b.keyAt(i));
            if (clientEventData != null) {
    ...
    public final void mo80408hr(long j, ClientEventData clientEventData) {
        ...
        if (a.ordinal() == 30) {
            ...
            if (!bwVar.f169962ag.mo58857o(r2.f169971d)) {
                C59104x d = f323295a.mo56226d();
                d.mo56378ag(C58975e.f156826a, "S_ActivityCompleted");
                ((C59052c) ((C59052c) d).mo56372aa(31970)).mo56386p("ACTIVITY_COMPLETED_WITH_RESULT client event received with the wrong extension.");
            ...
            this.f323296b.put(((C88150r) obj).f238284b, clientEventData);
            mo80591ar();
        }
    }
}
