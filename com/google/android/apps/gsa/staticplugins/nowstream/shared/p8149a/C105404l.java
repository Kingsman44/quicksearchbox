...
/* renamed from: com.google.android.apps.gsa.staticplugins.nowstream.shared.a.l */
/* compiled from: PG */
public final class C105404l implements C105403k {

    /* renamed from: a */
    public final C23112h f294025a;

    public C105404l(C23112h hVar) {
        this.f294025a = hVar;
    }

    /* renamed from: a */
    public final void mo94582a() {
        this.f294025a.mo28345s("onPullToRefreshEntries", "MainFeedRecyclerViewEventsDispatcher", new Bundle());
    }
    ...
    public final void mo94583b(boolean z) {
        ...
        this.f294025a.mo28345s("onRenderComplete_boolean", "MainFeedRecyclerViewEventsDispatcher", bundle);
    }
    ...
    public final void mo94584c(int i, int i2, boolean z) {
        ...
        this.f294025a.mo28345s("onScrollPositionUpdated_int_int_boolean", "MainFeedRecyclerViewEventsDispatcher", bundle);
    }
    ...
    public final void mo94585d(ProtoParcelable protoParcelable, int i, long j) {
        ...
        this.f294025a.mo28345s("reportViewHorizontallyScrolled_com.google.android.libraries.gsa.monet.shared.ProtoParcelable_int_long", "MainFeedRecyclerViewEventsDispatcher", bundle);
    }
    ...
    public final void mo94586g(long j, C58485gu guVar) {
        ...
        this.f294025a.mo28345s("reportViews_long_com.google.common.collect.ImmutableList<com.google.android.apps.gsa.sidekick.shared.monet.visualelementslogger.VisualElementBoundsParcelable>", "MainFeedRecyclerViewEventsDispatcher", bundle);
    }
    ...
    public final void mo94587je(Rect rect, long j) {
        ...
        bundle.putLong("timestamp", Long.valueOf(j).longValue());
        this.f294025a.mo28345s("reportViewport_android.graphics.Rect_long", "MainFeedRecyclerViewEventsDispatcher", bundle);
    }
    ...
    public final void mo94588jf(long j) {
        Bundle bundle = new Bundle();
        bundle.putLong("timestamp", Long.valueOf(j).longValue());
        this.f294025a.mo28345s("reportViewportHidden_long", "MainFeedRecyclerViewEventsDispatcher", bundle);
    }
