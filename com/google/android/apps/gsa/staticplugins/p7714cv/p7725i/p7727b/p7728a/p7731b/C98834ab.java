...
/* renamed from: com.google.android.apps.gsa.staticplugins.cv.i.b.a.b.ab */
/* compiled from: PG */
public final class C98834ab implements C92265b {

    /* renamed from: a */
    private static final C59071e f276145a = C59071e.m91332i("com.google.android.apps.gsa.staticplugins.cv.i.b.a.b.ab");

    /* renamed from: b */
    private final Query f276146b;

    /* renamed from: c */
    private final C98708a f276147c = new C98708a();

    /* renamed from: d */
    private final C23319a f276148d = new C23319a();

    /* renamed from: e */
    private final C118979t f276149e;

    public C98834ab(Query query, C118979t tVar) {
        this.f276146b = query;
        this.f276149e = tVar;
    }
    ...
    public final void mo86946b(C90528t tVar) {
        this.f276149e.mo91307d(2, this.f276148d.f63817b, tVar);
    }
    ...
    public final void mo59867h(C67438ag agVar) {
        ...
        if ((agVar.f183258a & 1) != 0) {
            ...
            if (a2 != C67446ao.STATUS_SUCCESS) {
                ((C59052c) ((C59052c) f276145a.mo56226d()).mo56372aa(31204)).mo56386p("Ignoring recognition event without success status code.");
                return;
            }
            this.f276147c.mo91274b(agVar);
            int a3 = C67437af.m97466a(agVar.f183259b);
            if (a3 == 0 || a3 == 1) {
                int i = agVar.f183258a;
                if ((i & 8) != 0 || (i & 4) != 0) {
                    Pair a4 = this.f276148d.mo28812a(agVar);
                    this.f276149e.mo91312i(2, this.f276146b, new C118895a((String) a4.first, (String) a4.second, false, (String) null));
                    return;
                }
                return;
            }
            int a5 = C67437af.m97466a(agVar.f183259b);
            if (a5 != 0 && a5 == 2 && (a = this.f276147c.mo91273a()) != null) {
                C23319a aVar = this.f276148d;
                if (aVar.f63817b) {
                    ((C59052c) ((C59052c) f276145a.mo56225c()).mo56372aa(31209)).mo56386p("Result after completed recognition.");
                    return;
                }
                ...
                if (a6.first == null || TextUtils.isEmpty((CharSequence) a6.first)) {
                    ((C59052c) ((C59052c) f276145a.mo56224b()).mo56372aa(31207)).mo56386p("Empty final recognition result");
                    this.f276149e.mo91309f(2);
                    return;
                }
                this.f276149e.mo91313j(2);
                this.f276149e.mo91312i(2, this.f276146b, new C118895a(((SpannedString) a6.first).toString(), BuildConfig.FLAVOR, true, (String) null));
                ...
                Query aG = this.f276146b.mo84270aG((CharSequence) a6.first, (C58485gu) a6.second, j, true);
                ...
                this.f276149e.mo91311h(2, aG, (C86232bo) null);
                return;
            }
            return;
        }
        ((C59052c) ((C59052c) f276145a.mo56226d()).mo56372aa(31205)).mo56386p("Ignoring recognition event without type.");
    }
}
