...
/* renamed from: com.google.android.apps.gsa.staticplugins.opamediaplayer.ui.speakr.ag */
/* compiled from: PG */
public final /* synthetic */ class C115658ag implements C23123s {

    /* renamed from: a */
    public final /* synthetic */ C115711cf f320850a;

    public /* synthetic */ C115658ag(C115711cf cfVar) {
        this.f320850a = cfVar;
    }

    /* renamed from: a */
    public final void mo28366a(Object obj) {
        C115711cf cfVar = this.f320850a;
        C58833ax axVar = (C58833ax) obj;
        if (axVar.mo56113h()) {
            C115423aa aaVar = (C115423aa) axVar.mo56107c();
            MenuItem findItem = cfVar.f321207a.mo2393g().findItem(R.id.speakr_menu_item_text_highlighting_toggle);
            ...
            if (!cfVar.f320918F.mo56113h()) {
                ...
                ((C59052c) ((C59052c) d).mo56372aa(30004)).mo56386p("Highlighter not initialized yet.");
                return;
            }
            ((C89315s) cfVar.f320918F.mo56107c()).mo83243b();
        }
    }
}
