...
/* renamed from: com.google.android.apps.gsa.staticplugins.accl.performers.communication.ap */
/* compiled from: PG */
public final /* synthetic */ class C93005ap implements C58817ah {

    /* renamed from: a */
    public static final /* synthetic */ C93005ap f259453a = new C93005ap();

    private /* synthetic */ C93005ap() {
    }

    public final Object apply(Object obj) {
        Location location = (Location) obj;
        C59071e eVar = C93008as.f259456a;
        if (location != null) {
        ...
        C59104x c = C93008as.f259456a.mo56225c();
        c.mo56378ag(C58975e.f156826a, "ShareLocationFetch");
        ((C59052c) ((C59052c) c).mo56372aa(13196)).mo56386p("Failed to retrieve user's location.");
        throw new RuntimeException("Failed to retrieve user's location.");
    }
}
