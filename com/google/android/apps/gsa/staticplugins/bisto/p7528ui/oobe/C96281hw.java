...
/* renamed from: com.google.android.apps.gsa.staticplugins.bisto.ui.oobe.hw */
/* compiled from: PG */
public final /* synthetic */ class C96281hw implements C83871ae {

    /* renamed from: a */
    public final /* synthetic */ C96283hy f269446a;

    public /* synthetic */ C96281hw(C96283hy hyVar) {
        this.f269446a = hyVar;
    }

    /* renamed from: a */
    public final void mo77211a(C83907bm bmVar) {
        C96283hy hyVar = this.f269446a;
        C96248gq gqVar = (C96248gq) bmVar;
        if (hyVar.f269449a != null) {
            ((C89492cd) hyVar.f269450b.mo27525b()).mo83368J(hyVar.f269449a, C124707e.INPUT_OUTPUT_MODE);
            ...
            kzVar.f162533a |= 128;
            kzVar.f162539g = "BISTO_CONNECTION_MODE_DATA_AUDIO";
        }
        hyVar.mo90046a(5);
    }
}
