...
/* renamed from: com.google.android.apps.gsa.staticplugins.opa.worker.g.b */
/* compiled from: PG */
public final class C114315b implements C68220f {
    /* renamed from: a */
    public static C118474ai m189603a(C68214a aVar) {
        C118473ah ahVar = (C118473ah) C118474ai.f328830g.createBuilder();
        long millis = Duration.ofHours(((C86124t) aVar.mo27525b()).mo79743a(C90063do.f249628hc)).toMillis();
        ahVar.copyOnWrite();
        C118474ai aiVar = (C118474ai) ahVar.instance;
        aiVar.f328832a |= 1;
        aiVar.f328833b = millis;
        boolean e = ((C86124t) aVar.mo27525b()).mo79746e(C90063do.f249435dV);
        ahVar.copyOnWrite();
