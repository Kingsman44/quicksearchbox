...
/* renamed from: com.google.android.apps.gsa.staticplugins.opa.samson.j.x */
/* compiled from: PG */
final class C110226x extends C83869ac {

    /* renamed from: a */
    final /* synthetic */ C110190aa f307141a;

    public C110226x(C110190aa aaVar) {
        this.f307141a = aaVar;
    }
    ...
    public final C83956t mo77207a() {
        return C83875ai.m133537b(new C110217o());
    }

    /* access modifiers changed from: protected */
    /* renamed from: b */
    public final boolean mo77208b() {
        C110190aa aaVar = this.f307141a;
        if (!aaVar.mo98463b()) {
            return true;
        }
        ...
        d.getClass();
        return !((C110361bt) aaVar.f307034d.mo27525b()).mo98594k(str, d);
    }
}
