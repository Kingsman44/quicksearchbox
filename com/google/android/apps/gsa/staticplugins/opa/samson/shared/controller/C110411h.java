...
/* renamed from: com.google.android.apps.gsa.staticplugins.opa.samson.shared.controller.h */
/* compiled from: PG */
public final /* synthetic */ class C110411h implements Runnable {

    /* renamed from: a */
    public final /* synthetic */ C110415l f307744a;

    public /* synthetic */ C110411h(C110415l lVar) {
        this.f307744a = lVar;
    }

    public final void run() {
        Activity activity = this.f307744a.f307750b;
        Bundle bundle = new Bundle();
        bundle.putBoolean("seq_args_is_ch_am", true);
        C83879am o = C83880an.m133553o();
        C83940g gVar = (C83940g) o;
        gVar.f228605a = "ch_am_notif_seq";
