...
/* renamed from: com.google.android.apps.gsa.staticplugins.opa.samson.n.k */
/* compiled from: PG */
public final /* synthetic */ class C110274k implements Runnable {

    /* renamed from: a */
    public final /* synthetic */ C110283t f307304a;

    public /* synthetic */ C110274k(C110283t tVar) {
        this.f307304a = tVar;
    }

    public final void run() {
        Activity activity = this.f307304a.f307316d;
        Bundle bundle = new Bundle();
        bundle.putBoolean("seq_args_is_ch_am", true);
        C83879am o = C83880an.m133553o();
        C83940g gVar = (C83940g) o;
        gVar.f228605a = "ch_am_personal_seq";
