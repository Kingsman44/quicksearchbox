...
/* renamed from: com.google.android.apps.gsa.staticplugins.opa.morris2.e.m */
/* compiled from: PG */
public final /* synthetic */ class C109523m implements C60931s {

    /* renamed from: a */
    public static final /* synthetic */ C109523m f305043a = new C109523m();

    private /* synthetic */ C109523m() {
    }

    public final C60870cx apply(Object obj) {
        C36607j jVar = (C36607j) C36608k.f95440d.createBuilder();
        C36609l lVar = C36609l.NOTIFICATION_OBSERVER_MORRIS;
        jVar.copyOnWrite();
        C36608k kVar = (C36608k) jVar.instance;
        kVar.f95443b = lVar.getNumber();
        kVar.f95442a |= 1;
        return ((C36610m) obj).mo40233b((C36608k) jVar.build());
    }
}
