...
/* renamed from: com.google.android.apps.gsa.search.core.ca */
/* compiled from: PG */
final class C85681ca implements C85740cd {

    /* renamed from: a */
    final /* synthetic */ C21761b f231653a;

    public C85681ca(C21761b bVar) {
        this.f231653a = bVar;
    }
    ...
    public final /* bridge */ /* synthetic */ void mo79205a(Object obj, Object obj2) {
        ...
        dVar.f60064a |= 1;
        dVar.f60065b = str;
        String g = C58837ba.m90858g((String) obj);
        cVar.copyOnWrite();
        C21763d dVar2 = (C21763d) cVar.instance;
        dVar2.f60064a |= 2;
        dVar2.f60066c = g;
        C21763d dVar3 = (C21763d) cVar.build();
        C21761b bVar = this.f231653a;
        bVar.copyOnWrite();
        C21764e eVar = (C21764e) bVar.instance;
        C21764e eVar2 = C21764e.f60067e;
        dVar3.getClass();
        C62971cq cqVar = eVar.f60071c;
        if (!cqVar.mo58948c()) {
            eVar.f60071c = C62942bv.mutableCopy(cqVar);
        }
        eVar.f60071c.add(dVar3);
    }
}
