...
/* renamed from: com.google.android.apps.gsa.search.core.google.gaia.b.c */
/* compiled from: PG */
public final class C86019c implements C68220f {
    /* renamed from: a */
    public static C118474ai m138323a() {
        C118473ah ahVar = (C118473ah) C118474ai.f328830g.createBuilder();
        ahVar.copyOnWrite();
        C118474ai aiVar = (C118474ai) ahVar.instance;
        aiVar.f328834c = 1;
        aiVar.f328832a |= 2;
        long millis = TimeUnit.MINUTES.toMillis(570);
        ahVar.copyOnWrite();
