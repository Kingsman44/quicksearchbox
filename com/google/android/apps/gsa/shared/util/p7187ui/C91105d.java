...
public final class C91105d implements TimeInterpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = f254402b;
        float f2 = fArr[min];
        return f2 + (((f - (((float) min) * 0.01f)) / 0.01f) * (fArr[min + 1] - f2));
    }
}
