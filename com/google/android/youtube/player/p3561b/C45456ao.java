...
/* renamed from: com.google.android.youtube.player.b.ao */
public final class C45456ao {
    /* renamed from: a */
    public static void m81110a(Map map, String str) {
        String str2;
        String str3;
        if ("af".equals(str)) {
            m81111b(map);
        } else if (C141584am.f384270a.equals(str)) {
            m81112c(map);
            ...
            if ("hi".equals(str)) {
                ...
                str2 = "YouTube एप्लि. अपडेट करें";
                map.put("update_youtube_app_title", str2);
                str3 = "जब तक आप YouTube एप्लिकेशन अपडेट नहीं करते, तब तक यह एप्लिकेशन कार्य नहीं करेगा.";
            } else {
                if ("hr".equals(str)) {
                    ...
                    str2 = "YouTube alk. frissítése";
                    map.put("update_youtube_app_title", str2);
                    str3 = "Az alkalmazás csak akkor fog működni, ha frissíti a YouTube alkalmazást.";
                    ...
                    str2 = "Perbarui Aplikasi YouTube";
                    map.put("update_youtube_app_title", str2);
                    str3 = "Aplikasi ini tidak akan bekerja kecuali Anda memperbarui Aplikasi YouTube.";
                    ...
                    str2 = "Aggiorna app YouTube";
                    map.put("update_youtube_app_title", str2);
                    str3 = "Questa applicazione non funzionerà se non aggiorni l'applicazione YouTube.";
                    ...
                    str2 = "Zaktualizuj aplikację YouTube";
                    ...
                    str2 = "Sasisha Programu ya YouTube";
                    ...
                    str2 = "อัปเดตแอปพลิเคชัน YouTube";
                    ...
                    str2 = "YouTube Uygulamasını güncelle";
                    ...
                    str2 = "Cập nhật ứng dụng YouTube";
                    ...
                    str2 = "Buyekeza uhlelo lokusebenza lwe-YouTube";
                } else {
                    return;
                }
                map.put("update_youtube_app_action", str2);
            }
            map.put("update_youtube_app_text", str3);
            map.put("update_youtube_app_action", str2);
        }
    }

    /* renamed from: b */
    private static void m81111b(Map map) {
    ...
    /* renamed from: c */
    private static void m81112c(Map map) {
    ...
    /* renamed from: d */
    private static void m81113d(Map map) {
    ...
    /* renamed from: e */
    private static void m81114e(Map map) {
    ...
    /* renamed from: f */
    private static void m81115f(Map map) {
    ...
    /* renamed from: g */
    private static void m81116g(Map map) {
    ...
    /* renamed from: h */
    private static void m81117h(Map map) {
    ...
    /* renamed from: i */
    private static void m81118i(Map map) {
    ...
    /* renamed from: j */
    private static void m81119j(Map map) {
    ...
    /* renamed from: k */
    private static void m81120k(Map map) {
    ...
    /* renamed from: l */
    private static void m81121l(Map map) {
    ...
    /* renamed from: m */
    private static void m81122m(Map map) {
    ...
    /* renamed from: n */
    private static void m81123n(Map map) {
    ...
    /* renamed from: o */
    private static void m81124o(Map map) {
    ...
    /* renamed from: p */
    private static void m81125p(Map map) {
    ...
    /* renamed from: q */
    private static void m81126q(Map map) {
    ...
    /* renamed from: r */
    private static void m81127r(Map map) {
