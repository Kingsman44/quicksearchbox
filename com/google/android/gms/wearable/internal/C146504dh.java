...
public final class C146504dh {
    ...
    /* renamed from: c */
    static final boolean m238505c(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return m238507e(packageInfo, f395701a, f395702b);
        }
        return m238507e(packageInfo, f395701a);
    }

    /* renamed from: d */
    private static byte[] m238506d(String str) {
        try {
    ...
    /* renamed from: e */
    private static final boolean m238507e(PackageInfo packageInfo, byte[]... bArr) {
    ...
    /* renamed from: b */
    public final boolean mo123292b() {
        PackageInfo packageInfo;
        try {
            packageInfo = C143873c.f389983a.mo119351a(this.f395704d).mo119348b("com.google.android.wearable.app.cn", 64);
        ...
        if (C143700ab.m233444f(this.f395704d)) {
            return m238505c(packageInfo, true);
        }
        boolean c = m238505c(packageInfo, false);
        if (c || !m238505c(packageInfo, true)) {
            return c;
        }
