...
/* renamed from: com.google.android.gms.search.global.l */
/* compiled from: PG */
public final class C145908l extends C145863b {

    /* renamed from: a */
    private final SetExperimentIdsCall$Request f394476a;

    public C145908l(SetExperimentIdsCall$Request setExperimentIdsCall$Request, C143851w wVar) {
        super(C145891g.f394441n, wVar);
        this.f394476a = setExperimentIdsCall$Request;
    }
    ...
    public final /* bridge */ /* synthetic */ C143711ad mo117683c(Status status) {
        ...
        setExperimentIdsCall$Response.f394466a = status;
        return setExperimentIdsCall$Response;
    }
    ...
    public final /* bridge */ /* synthetic */ void mo117681h(C143717b bVar) {
        ...
        SetExperimentIdsCall$Request setExperimentIdsCall$Request = this.f394476a;
        C145894b bVar2 = new C145894b(this, SetExperimentIdsCall$Response.class);
        Parcel gA = eVar.mo17260gA();
        C8850c.m23497f(gA, setExperimentIdsCall$Request);
