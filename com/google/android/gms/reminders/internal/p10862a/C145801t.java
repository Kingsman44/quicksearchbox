...
/* renamed from: com.google.android.gms.reminders.internal.a.t */
/* compiled from: PG */
public final class C145801t extends C145782a {

    /* renamed from: a */
    final /* synthetic */ Task f394174a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C145801t(C143851w wVar, Task task) {
        super(wVar);
        this.f394174a = task;
    }
    ...
    public final /* synthetic */ void mo117681h(C143717b bVar) {
        ...
        Task task = this.f394174a;
        C143919bh.m233969l(jVar.f394182a.mo119476a());
        C143919bh.m233958a(task);
        ((C145809f) jVar.mo119451G()).mo121960e(new C145812i(this), new TaskEntity(task));
    }
}
