...
public final class UnregisterDistributedServiceAvailabilityCallbackParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new C146266cb();

    /* renamed from: a */
    public C146215ae f395055a;

    /* renamed from: b */
    public String f395056b;

    /* renamed from: c */
    public C146286v f395057c;
    ...
    public UnregisterDistributedServiceAvailabilityCallbackParams(android.os.IBinder r4, java.lang.String r5, android.os.IBinder r6) {
        /*
            r3 = this;
            r0 = 0
        ...
        L_0x002d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.usonia.directory.internal.UnregisterDistributedServiceAvailabilityCallbackParams.<init>(android.os.IBinder, java.lang.String, android.os.IBinder):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UnregisterDistributedServiceAvailabilityCallbackParams) {
            ...
            return C143912ba.m233950b(this.f395055a, unregisterDistributedServiceAvailabilityCallbackParams.f395055a) && C143912ba.m233950b(this.f395056b, unregisterDistributedServiceAvailabilityCallbackParams.f395056b) && C143912ba.m233950b(this.f395057c, unregisterDistributedServiceAvailabilityCallbackParams.f395057c);
        }
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f395055a, this.f395056b, this.f395057c});
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = C143947c.m234082a(parcel, 20293);
        C143947c.m234098q(parcel, 1, this.f395055a.asBinder());
        C143947c.m234106y(parcel, 2, this.f395056b);
        C143947c.m234098q(parcel, 3, this.f395057c.asBinder());
