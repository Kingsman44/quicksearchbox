...
public final class OnDistributedServiceOfflineParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new C146253bp();

    /* renamed from: a */
    public String f395030a;

    /* renamed from: b */
    public PeerAddress f395031b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof OnDistributedServiceOfflineParams) {
            ...
            return C143912ba.m233950b(this.f395030a, onDistributedServiceOfflineParams.f395030a) && C143912ba.m233950b(this.f395031b, onDistributedServiceOfflineParams.f395031b);
        }
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f395030a, this.f395031b});
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = C143947c.m234082a(parcel, 20293);
        C143947c.m234106y(parcel, 1, this.f395030a);
        C143947c.m234105x(parcel, 2, this.f395031b, i);
