...
public final class UnregisterStateCallbackParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new C146267cc();

    /* renamed from: a */
    public C146215ae f395058a;

    /* renamed from: b */
    public String f395059b;

    /* renamed from: c */
    public C146283s f395060c;
    ...
    public UnregisterStateCallbackParams(android.os.IBinder r4, java.lang.String r5, android.os.IBinder r6) {
        /*
            r3 = this;
            r0 = 0
        ...
        L_0x002d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.usonia.directory.internal.UnregisterStateCallbackParams.<init>(android.os.IBinder, java.lang.String, android.os.IBinder):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UnregisterStateCallbackParams) {
            ...
            return C143912ba.m233950b(this.f395058a, unregisterStateCallbackParams.f395058a) && C143912ba.m233950b(this.f395059b, unregisterStateCallbackParams.f395059b) && C143912ba.m233950b(this.f395060c, unregisterStateCallbackParams.f395060c);
        }
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f395058a, this.f395059b, this.f395060c});
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = C143947c.m234082a(parcel, 20293);
        C143947c.m234098q(parcel, 1, this.f395058a.asBinder());
        C143947c.m234106y(parcel, 2, this.f395059b);
        C143947c.m234098q(parcel, 3, this.f395060c.asBinder());
