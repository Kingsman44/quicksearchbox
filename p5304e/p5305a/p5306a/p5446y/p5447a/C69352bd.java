...
/* renamed from: e.a.a.y.a.bd */
/* compiled from: PG */
public final class C69352bd implements C69350bb {

    /* renamed from: a */
    public static final C31718bj f185515a;
    ...
    static {
        ...
        try {
            f185515a = f.mo37342d("10", (C71304ef) C62942bv.parseFrom((C62942bv) C71304ef.f190405d, Base64.decode("EOgHGAQ", 3)), C69351bc.f185514a);
        } catch (Exception e) {
    ...
    /* renamed from: a */
    public final C71304ef mo61026a(Context context) {
        return (C71304ef) f185515a.mo37336b(context);
    }
}
