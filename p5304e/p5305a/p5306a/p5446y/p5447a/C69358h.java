...
/* renamed from: e.a.a.y.a.h */
/* compiled from: PG */
public final class C69358h implements C69356f {

    /* renamed from: a */
    public static final C31718bj f185522a;
    ...
    static {
        ...
        try {
            f185522a = f.mo37342d("16", (C71304ef) C62942bv.parseFrom((C62942bv) C71304ef.f190405d, Base64.decode("EAAYAg", 3)), C69357g.f185521a);
        } catch (Exception e) {
    ...
    /* renamed from: a */
    public final C71304ef mo61028a(Context context) {
        return (C71304ef) f185522a.mo37336b(context);
    }
}
