...
/* renamed from: e.a.a.y.a.av */
/* compiled from: PG */
public final class C69343av implements C69341at {

    /* renamed from: a */
    public static final C31718bj f185507a;
    ...
    static {
        ...
        try {
            f185507a = f.mo37342d("17", (C71304ef) C62942bv.parseFrom((C62942bv) C71304ef.f190405d, Base64.decode("EOgHGAM", 3)), C69342au.f185506a);
        } catch (Exception e) {
    ...
    /* renamed from: a */
    public final C71304ef mo61020a(Context context) {
        return (C71304ef) f185507a.mo37336b(context);
    }
}
