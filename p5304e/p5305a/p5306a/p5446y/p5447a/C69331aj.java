...
/* renamed from: e.a.a.y.a.aj */
/* compiled from: PG */
public final class C69331aj implements C69329ah {

    /* renamed from: a */
    public static final C31718bj f185493a;
    ...
    static {
        ...
        try {
            f185493a = f.mo37342d("12", (C71304ef) C62942bv.parseFrom((C62942bv) C71304ef.f190405d, Base64.decode("EAAYAg", 3)), C69330ai.f185492a);
        } catch (Exception e) {
    ...
    /* renamed from: a */
    public final C71304ef mo61012a(Context context) {
        return (C71304ef) f185493a.mo37336b(context);
    }
}
