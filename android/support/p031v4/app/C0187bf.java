...
/* compiled from: PG */
final class C0187bf implements C0815b {

    /* renamed from: a */
    final /* synthetic */ FragmentManager f758a;

    public C0187bf(FragmentManager fragmentManager) {
        this.f758a = fragmentManager;
    }

    public final /* bridge */ /* synthetic */ void onActivityResult(Object obj) {
        ActivityResult activityResult = (ActivityResult) obj;
        FragmentManager.LaunchedFragmentInfo launchedFragmentInfo = (FragmentManager.LaunchedFragmentInfo) this.f758a.f655v.pollFirst();
        ...
        Fragment d = this.f758a.f634a.mo672d(str);
        if (d == null) {
